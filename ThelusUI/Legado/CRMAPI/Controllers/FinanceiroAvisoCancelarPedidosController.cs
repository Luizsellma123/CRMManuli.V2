...
{
    public class FinanceiroAvisoCancelarPedidosController : ApiController
    {
        public HttpResponseMessage GetAllFinanceiroAvisoCancelarPedidos()
        {
            return Request.CreateErrorResponse(HttpStatusCode.Created, "Nada a retornar");
        }

        public HttpResponseMessage PostFinanceiroAvisoCancelarPedidos()
        {
            ...
            try
            {
                OBJRetorno.MsgRetorno = OBJFinanceiro.AvisoCancelaPedidosPeriodoCRM();
