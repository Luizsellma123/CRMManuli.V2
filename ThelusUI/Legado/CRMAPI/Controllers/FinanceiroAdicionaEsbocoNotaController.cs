...
{
    public class FinanceiroAdicionaEsbocoNotaController : ApiController
    {
        ...
        public HttpResponseMessage PostAtualizaAnalisarEsboco(FinanceiroClass OBJFinanceiro)
        {
            ...
            try
            {
                ...
                OBJRetorno.MsgRetorno = OBJFinanceiro.AdicionaEsbocoNota();

                //Se não der erro atribui o Numero Primario da Nota
                if (OBJRetorno.MsgRetorno == "")
                {
                    OBJRetorno.NumeroPrimarioNotaSAP = OBJFinanceiro.NumeroPrimarioNotaSAP;
                }
