...
{
    public class ChatBotRetornaClienteController : ApiController
    {
        public HttpResponseMessage GetAllChatBotRetornaClienteController()
        {
            return Request.CreateErrorResponse(HttpStatusCode.Created, "Nada a retornar");
        }

        public HttpResponseMessage PostChatBotRetornaCliente(DadosClienteChatBotModel OBJDadosClienteChatBot)
        {
            ...
            try
            {
                OBJRetorno.MsgRetorno = OBJDadosClienteChatBot.RecuperaDadosCliente();
