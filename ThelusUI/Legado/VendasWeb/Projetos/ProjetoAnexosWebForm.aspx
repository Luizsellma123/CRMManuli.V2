<%@ Page Title="" Language="C#" MasterPageFile="~/NestedMasterPageCRM.master" AutoEventWireup="true" CodeBehind="ProjetoAnexosWebForm.aspx.cs" Inherits="VendasWeb.Chamados.ProjetoAnexosWebForm" %>
        ...
        <div class="col-sm-12">
            ...
            <div class="panel panel-info">
                ...
                <div class="panel-heading">
                    ...
                    <h3 class="panel-title">Projetos - Anexos</h3>
                </div>
                <!--Painel Aberto-->
                ...
                <div class="panel-body">
                        ...
                        <div class="col-sm-6">
                            <div class="form-group">
                                ...
                                <asp:RequiredFieldValidator ID="RequiredFieldValidator1" runat="server"
                                    ControlToValidate="SolicitanteDropDownList" Display="Dynamic" ErrorMessage="*"
                    ...
                    <div class="row">
                        <div class="col-sm-2">
                            <div class="form-group">
                                <asp:Label ID="AssuntoLabel" runat="server" Text="Descrição:"></asp:Label>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="col-sm-12">
                            <div class="form-group">
                                ...
                                <asp:RequiredFieldValidator ID="RequiredFieldValidator8" runat="server"
                                    ControlToValidate="AssuntoBreveTextBox" Display="Dynamic" ErrorMessage="*"
                                    SetFocusOnError="True"></asp:RequiredFieldValidator>
                            </div>
                        </div>
                    </div>
                                    ...
                                    <asp:TemplateField HeaderText="Acessar">
                                        <ItemTemplate>
                                            <asp:UpdatePanel ID="TesteUpdatePanel" runat="server" UpdateMode="Conditional">
                                                ...
                                                <Triggers>
                                                    <asp:AsyncPostBackTrigger ControlID="ExcluirAnexoLinkButton" />
                                                </Triggers>
                                            </asp:UpdatePanel>
                                        </ItemTemplate>
                                    </asp:TemplateField>
