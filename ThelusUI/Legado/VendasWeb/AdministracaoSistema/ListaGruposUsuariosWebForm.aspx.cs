...
{
    public partial class ListaGruposUsuariosWebForm : System.Web.UI.Page
    {
        ...
        public void carregaDadosTela()
        {
            ...
            OBJDataTable = OBJUsuario.RetornaGruposUsuario();
            GruposUsuariosGridView.DataSource = OBJDataTable;
            GruposUsuariosGridView.DataBind();
            GruposUsuariosMultiView.Visible = true;
        }
        ...
        {
            OBJUsuario.IDGrupo = Convert.ToInt32(((Label)((Control)sender).FindControl("IDGrupoLabel")).Text);
        ...
        protected void GruposUsuariosGridView_PageIndexChanging(object sender, GridViewPageEventArgs e)
        {
            GruposUsuariosGridView.PageIndex = e.NewPageIndex;
            carregaDadosTela();
        }
    }
}