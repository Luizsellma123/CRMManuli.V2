<%@ Page Title="" Language="C#" MasterPageFile="~/NestedMasterPageCRM.master" AutoEventWireup="true" CodeBehind="ListaGruposMenuWebForm.aspx.cs" Inherits="VendasWeb.AdministracaoSistema.ListaGruposMenuWebForm" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div class="row">
        <div class="col-sm-9">
            ...
            <div class="panel panel-info">
                ...
                <div class="panel-heading">
                    ...
                    <h3 class="panel-title">Administração - Lista Grupos Menus</h3>
                </div>
                <!--Painel Aberto-->
        ...
        <!-- TABELA -->
        <!--===================================================-->
        <asp:MultiView ID="GruposMenusMultiView" runat="server" ActiveViewIndex="0" Visible="false">
            <asp:View ID="GruposMenusView" runat="server">

                <div class="panel">
                    <div class="panel-heading">
                        <h3 class="panel-title">Lista Grupos Menus 
                        </h3>
                    </div>
                    <!-- Foo Table - Filtering -->
                    <!--===================================================-->
                    <div class="panel-body">
                        <div class="table-responsive">
                            <asp:UpdatePanel ID="TesteUpdatePanel2" runat="server" UpdateMode="Conditional">
                                <ContentTemplate>
                                    <asp:GridView ID="GruposMenusGridView" EmptyDataText="Não foi possível encontrar nenhuma simulação" AutoGenerateColumns="False"
