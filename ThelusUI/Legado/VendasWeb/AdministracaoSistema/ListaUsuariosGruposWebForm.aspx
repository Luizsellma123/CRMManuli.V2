<%@ Page Title="" Language="C#" MasterPageFile="~/NestedMasterPageCRM.master" AutoEventWireup="true" CodeBehind="ListaUsuariosGruposWebForm.aspx.cs" Inherits="VendasWeb.AdministracaoSistema.ListaUsuariosGruposWebForm" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div class="row">
                    ...
                    <div class="row">
                        <div class="col-sm-2">
                            <div class="form-group">
                                <asp:Label ID="CodigoGrupoLabel" runat="server" Text="Grupo :"></asp:Label>
                            </div>
                        </div>
                        ...
                        <div class="col-sm-4">
                            <div class="form-group">
                                ...
                                <asp:RequiredFieldValidator ID="RequiredFieldValidator2" runat="server"
                                    ControlToValidate="CodigoGrupoTextBox" Display="Dynamic" ErrorMessage="*"
        ...
        <!-- TABELA -->
        <!--===================================================-->
        <asp:MultiView ID="UsuariosGruposMultiView" runat="server" ActiveViewIndex="0" Visible="false">
            <asp:View ID="UsuariosGruposView" runat="server">

                <div class="panel">
                    <div class="panel-heading">
                        <h3 class="panel-title">Lista Usuários Grupos 
                        </h3>
                    </div>
                    <!-- Foo Table - Filtering -->
                    <!--===================================================-->
                    <div class="panel-body">
                        <div class="table-responsive">
                            ...
                            <asp:UpdatePanel ID="UsuariosGruposUpdatePanel" runat="server" UpdateMode="Conditional">
                                <ContentTemplate>

                                    <asp:GridView ID="UsuariosGruposGridView" EmptyDataText="Não foi possível encontrar nenhuma simulação" AutoGenerateColumns="False"
                                        ...
                                        Style="border-collapse: collapse; max-width: 100%" OnPageIndexChanging="UsuariosGruposGridView_PageIndexChanging">
                                ...
                                <Triggers>
                                    <asp:PostBackTrigger ControlID="UsuariosGruposGridView" />
                                </Triggers>
                            </asp:UpdatePanel>
