<%@ Page Title="" Language="C#" MasterPageFile="~/NestedMasterPageCRM.master" AutoEventWireup="true" CodeBehind="ListaCadastroSetoresWebForm.aspx.cs" Inherits="VendasWeb.AdministracaoSistema.ListaCadastroSetoresWebForm" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div class="row">
        <div class="col-sm-9">
            ...
            <div class="panel panel-info">
                ...
                <div class="panel-heading">
                    ...
                    <h3 class="panel-title">Administração - Lista Setores</h3>
                </div>
                <!--Painel Aberto-->
                ...
                <div class="panel-body">
                    ...
                    <div class="row">
                        ...
                        <div class="col-sm-4">
                            <div class="form-group">
                                <div class="form-group">
                                    <asp:TextBox ID="NomeSetorTextBox" runat="server" CssClass="form-control" placeholder="Nome ou Código."></asp:TextBox>
                                </div>
                            </div>
                        </div>
            ...
            <div class="panel-footer">
                <div class="row">
                    <div class="panel-control">
                        ...
                        <asp:LinkButton ID="NovoSetorLinkButton" class="btn btn-success btn-labeled fa fa-plus-circle fa-lg"
                            CausesValidation="false" runat="server" OnClick="NovoSetorLinkButton_Click">Novo</asp:LinkButton>
        ...
        <!-- TABELA -->
        <!--===================================================-->
        <asp:MultiView ID="SetoresMultiView" runat="server" ActiveViewIndex="0" Visible="false">
            <asp:View ID="SetoresView" runat="server">
                <div class="panel">
                    <div class="panel-heading">
                        <h3 class="panel-title">Lista Setores
                        </h3>
                    </div>
                    <!-- Foo Table - Filtering -->
                    <!--===================================================-->
                    <div class="panel-body">
                        <div class="table-responsive">
                            ...
                            <asp:GridView ID="SetoresGridView" EmptyDataText="Não foi possível encontrar nenhuma simulação" AutoGenerateColumns="False"
                                ...
                                Style="border-collapse: collapse; max-width: 100%" OnPageIndexChanging="SetoresGridView_PageIndexChanging" Visible="true">
                                ...
                                <Columns>
                                    ...
                                    <asp:TemplateField HeaderText="Nome ">
                                        <ItemTemplate>
                                            <asp:Label ID="NomeSetorLabel" runat="server" Text='<%# Bind("Descricao") %>'></asp:Label>
                                        </ItemTemplate>
                                    </asp:TemplateField>

                                    <asp:TemplateField HeaderText="Status">
                                        <ItemTemplate>
                                            <asp:Label ID="StatusMenuLabel" runat="server" Text='<%# Bind("Status") %>'></asp:Label>
                                        </ItemTemplate>
                                    </asp:TemplateField>
