<%@ Page Title="" Language="C#" MasterPageFile="~/NestedMasterPageCRM.master" AutoEventWireup="true" CodeBehind="CadastroUsuarioVendedoresWebForm.aspx.cs" Inherits="VendasWeb.AdministracaoSistema.CadastroUsuarioVendedoresWebForm" %>
    ...
    <div class="row">
        <div class="col-sm-9">
            ...
            <div class="panel panel-info">
                ...
                <div class="panel-heading">
                    ...
                    <h3 class="panel-title">Cadastro Usuários - Vendedores</h3>
                </div>
                <!--Painel Aberto-->
                ...
                <div class="row">
                    <div class="panel-control">
                        <asp:UpdatePanel ID="TesteUpdatePanel" runat="server" UpdateMode="Conditional">
                            <ContentTemplate>
                                <asp:LinkButton ID="AdicionaVendedorLinkButton" class="btn btn-success btn-labeled fa fa-arrow-circle-down fa-lg"
                                    CausesValidation="false" runat="server" OnClick="AdicionaVendedorLinkButton_Click">Adiciona Vendedor</asp:LinkButton>
                            ...
                            <Triggers>
                                <asp:PostBackTrigger ControlID="AdicionaVendedorLinkButton" />
                            </Triggers>
                        </asp:UpdatePanel>
        ...
        <asp:MultiView ID="UsuariosVendedoresMultiView" runat="server" ActiveViewIndex="0" Visible="true">
            <asp:View ID="PSIUView" runat="server">
                ...
                <div class="panel">
                    <div class="panel-heading">
                        <h3 class="panel-title">Lista Vendedores do Usuário
                        </h3>
                    </div>
                    <!-- Foo Table - Filtering -->
                    <!--===================================================-->
                            ...
                            <asp:GridView ID="UsuariosVendedoresGridView" EmptyDataText="Não foram encontrados dados com esses filtros" AutoGenerateColumns="False"
                                ...
                                <Columns>
                                    ...
                                    <asp:TemplateField HeaderText="IDVendedor" Visible="false">
                                        <ItemTemplate>
                                            <asp:Label ID="IDVendedorLabel" runat="server" Text='<%# Bind("IDVendedor") %>'></asp:Label>
                                        </ItemTemplate>
                                    </asp:TemplateField>
