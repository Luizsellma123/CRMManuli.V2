<%@ Page Title="" Language="C#" MasterPageFile="~/NestedMasterPageCRM.master" AutoEventWireup="true" CodeBehind="ListaCadastroUsuarioWebForm.aspx.cs" Inherits="VendasWeb.AdministracaoSistema.ListaCadastroUsuarioWebForm" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <div class="row">
        <div class="col-sm-9">
            ...
            <div class="panel panel-info">
                ...
                <div class="panel-heading">
                    ...
                    <h3 class="panel-title">Administração - Lista Usuários</h3>
                </div>
                <!--Painel Aberto-->
                ...
                <div class="panel-body">
                    ...
                    <div class="row">
                        ...
                        <div class="col-sm-4">
                            <div class="form-group">
                                <div class="form-group">
                                    <asp:TextBox ID="UsuarioTextBox" runat="server" CssClass="form-control" placeholder="Nome ou Código."></asp:TextBox>
                                </div>
                            </div>
                        </div>
                ...
                <div class="row">
                    <div class="panel-control">
                        ...
                        <asp:LinkButton ID="NovoUsuarioLinkButton" class="btn btn-success btn-labeled fa fa-plus-circle fa-lg"
                            CausesValidation="false" runat="server" OnClick="NovoUsuarioLinkButton_Click">Novo</asp:LinkButton>
        ...
        <asp:MultiView ID="UsuariosMultiView" runat="server" ActiveViewIndex="0" Visible="false">
            <asp:View ID="UsuariosView" runat="server">
                <!-- TABELA -->
                <!--===================================================-->
                <div class="panel">
                    <div class="panel-heading">
                        <h3 class="panel-title">Lista Usuários
                        </h3>
                    </div>
                    <!-- Foo Table - Filtering -->
                    <!--===================================================-->
                    <div class="panel-body">
                        <div class="table-responsive">
                            ...
                            <asp:GridView ID="UsuariosGridView" EmptyDataText="Não foi possível encontrar nenhuma simulação" AutoGenerateColumns="False"
                                ...
                                Style="border-collapse: collapse; max-width: 100%" OnPageIndexChanging="UsuariosGridView_PageIndexChanging">
                                ...
                                <Columns>
                                    ...
                                    <asp:TemplateField HeaderText="IDUsuario" Visible="false">
                                        <ItemTemplate>
                                            <asp:Label ID="IDusuaioLabel" runat="server" Text='<%# Bind("IDusuario") %>'></asp:Label>
                                        </ItemTemplate>
                                    </asp:TemplateField>
                                    ...
                                    <asp:TemplateField HeaderText="Status">
                                        <ItemTemplate>
                                            <asp:Label ID="StatusUsuarioLabel" runat="server" Text='<%# Bind("Status") %>'></asp:Label>
                                        </ItemTemplate>
                                    </asp:TemplateField>
                                    ...
                                    <asp:TemplateField HeaderText="Grupos">
                                        <ItemTemplate>
                                            <asp:UpdatePanel ID="GruposUpdatePanel" runat="server" UpdateMode="Conditional">
                                                <ContentTemplate>
                                                    <asp:LinkButton ID="GruposLinkButton" class="btn btn-info fa fa-users"
                                    ...
                                    <asp:TemplateField HeaderText="Menus">
                                        <ItemTemplate>
                                            <asp:UpdatePanel ID="MenusUpdatePanel" runat="server" UpdateMode="Conditional">
                                                <ContentTemplate>
                                                    <asp:LinkButton ID="MenusLinkButton" class="btn btn-info fa fa-arrows-alt"
                                                        CausesValidation="false" runat="server" OnClick="MenusLinkButton_Click"></asp:LinkButton>
                                                </ContentTemplate>
                                                <Triggers>
                                                    <asp:AsyncPostBackTrigger ControlID="MenusLinkButton" />
                                                </Triggers>
                                            </asp:UpdatePanel>
                                        </ItemTemplate>
                                    </asp:TemplateField>
