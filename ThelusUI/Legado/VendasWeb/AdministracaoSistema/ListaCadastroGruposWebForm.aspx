<%@ Page Title="" Language="C#" MasterPageFile="~/NestedMasterPageCRM.master" AutoEventWireup="true" CodeBehind="ListaCadastroGruposWebForm.aspx.cs" Inherits="VendasWeb.AdministracaoSistema.ListaCadastroGruposWebForm" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div class="row">
        <div class="col-sm-9">
            ...
            <div class="panel panel-info">
                ...
                <div class="panel-heading">
                    ...
                    <h3 class="panel-title">Administração - Lista Grupos</h3>
                </div>
                <!--Painel Aberto-->
                ...
                <div class="panel-body">
                    ...
                    <div class="row">
                        ...
                        <div class="col-sm-4">
                            <div class="form-group">
                                <div class="form-group">
                                    <asp:TextBox ID="GrupoTextBox" runat="server" CssClass="form-control" placeholder="Nome ou Código."></asp:TextBox>
                                </div>
                            </div>
                        </div>
            ...
            <div class="panel-footer">
                <div class="row">
                    <div class="panel-control">
                        ...
                        <asp:LinkButton ID="NovoGrupoLinkButton" class="btn btn-success btn-labeled fa fa-plus-circle fa-lg"
                            CausesValidation="false" runat="server" OnClick="NovoGrupoLinkButton_Click">Novo</asp:LinkButton>
        ...
        <!-- TABELA -->
                <!--===================================================-->
        <asp:MultiView ID="GruposMultiView" runat="server" ActiveViewIndex="0" Visible="false">
            <asp:View ID="GruposView" runat="server">
                                <div class="panel">
                    <div class="panel-heading">
                    ...
                    <div class="panel-body">
                        <div class="table-responsive">
                            ...
                            <asp:GridView ID="GruposGridView" EmptyDataText="Não foi possível encontrar nenhuma simulação" AutoGenerateColumns="False"
                                ...
                                Style="border-collapse: collapse; max-width: 100%" OnPageIndexChanging="GruposGridView_PageIndexChanging" Visible="true">
                                ...
                                <Columns>
                                    ...
                                    <asp:TemplateField HeaderText="Status">
                                        <ItemTemplate>
                                            <asp:Label ID="StatusGrupoLabel" runat="server" Text='<%# Bind("Status") %>'></asp:Label>
                                        </ItemTemplate>
                                    </asp:TemplateField>
