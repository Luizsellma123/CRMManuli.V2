<%@ Page Title="" Language="C#" MasterPageFile="~/CRM.Master" AutoEventWireup="true" CodeBehind="FrmCadExpClassDestalhes.aspx.cs" Inherits="VendasWeb.GerencialVendas.FrmCadExpClassDestalhes" %>
        ...
        <div class="col-sm-9">
            ...
            <div class="panel panel-info">
                ...
                <div class="panel-heading">
                    ...
                    <h3 class="panel-title">Cadastro Expectativas Incluir</h3>
                </div>
                <!--Painel Aberto-->
            ...
            <div class="panel-footer">
                <div class="row">
                    ...
                    <div class="panel-control">
                        <asp:LinkButton ID="RetornaLinkButton" class="btn btn-success btn-labeled fa fa-search fa-lg"
                            CausesValidation="false" OnClick="RetornaLinkButton_Click1" runat="server">Retorna</asp:LinkButton>
                    </div>

                    <div class="panel-control">
                        <asp:LinkButton ID="SalvarLinkButton" class="btn btn-success btn-labeled fa fa-search fa-lg"
                            CausesValidation="false" OnClick="BuscarLinkButton_Click1" runat="server">Salvar </asp:LinkButton>
                    </div>
