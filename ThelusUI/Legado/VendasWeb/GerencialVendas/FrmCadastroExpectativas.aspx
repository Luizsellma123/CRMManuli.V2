<%@ Page Title="" Language="C#" MasterPageFile="~/CRM.Master" AutoEventWireup="true" CodeBehind="FrmCadastroExpectativas.aspx.cs" Inherits="VendasWeb.GerencialVendas.FrmCadastroExpectativas" %>
        ...
        <div class="col-sm-9">
            ...
            <div class="panel panel-info">
                ...
                <div class="panel-heading">
                    ...
                    <h3 class="panel-title">Cadastro Expectativas</h3>
                </div>
                <!--Painel Aberto-->
                ...
                <div class="panel">
                    ...
                    <div class="panel-body">
                        <div class="table-responsive">
                            ...
                            <asp:GridView ID="ExpectativaGridView" EmptyDataText="Nenhum Cadastro Localizado" AutoGenerateColumns="False"
                                runat="server" AllowPaging="True" OnPageIndexChanging="ExpectativaGridView_PageIndexChanged"
                                ...
                                <Columns>
                                    ...
                                    <asp:TemplateField HeaderText="Deletar">
                                        <ItemTemplate>
                                            <asp:Button ID="btnDeletar" runat="server" Text="Deletar"
                                                CssClass="btn btn-danger" OnClick="btnDeletar_Click" />
                                        </ItemTemplate>
                                    </asp:TemplateField>
                                    ...
                                    <asp:TemplateField HeaderText="ID" Visible="false">
                                        <ItemTemplate>
                                            <asp:Label ID="ID_ExpectativaLabel" runat="server" Text='<%# Bind("ID_Expectativa") %>'></asp:Label>
                                        </ItemTemplate>
                                    </asp:TemplateField>


                                    <asp:TemplateField HeaderText="Nome Linha">
                                        <ItemTemplate>
                                            <asp:Label ID="NomeLinhaCodLabel" runat="server" Text='<%# Bind("LinhaProduto") %>'></asp:Label>
                                        </ItemTemplate>
                                    </asp:TemplateField>

                                    <asp:TemplateField HeaderText="Vendedor">
                                        <ItemTemplate>
                                            <asp:Label ID="VendedorLabel" runat="server" Text='<%# Bind("VendNome") %>'></asp:Label>
                                        </ItemTemplate>
                                    </asp:TemplateField>
                                    ...
                                    <asp:TemplateField HeaderText="Mês">
                                        <ItemTemplate>
                                            <asp:Label ID="DataVigenciaLabel" runat="server" Text='<%# Bind("Mes") %>'></asp:Label>
                                        </ItemTemplate>
                                    </asp:TemplateField>
                                    ...
                                    <asp:TemplateField HeaderText="Ano">
                                        <ItemTemplate>
                                            <asp:Label ID="AnoLabel" runat="server" Text='<%# Bind("Ano") %>'></asp:Label>
                                        </ItemTemplate>
                                    </asp:TemplateField>


                                    <asp:TemplateField HeaderText="Expectativa">
                                        <ItemTemplate>
                                            <asp:Label ID="ExpectativaLabel" runat="server" Text='<%# Bind("QuantidadeExpectativa") %>'></asp:Label>
                                        </ItemTemplate>
                                    </asp:TemplateField>
