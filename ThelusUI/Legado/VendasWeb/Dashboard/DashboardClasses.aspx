<%@ Page Title="" Language="C#" MasterPageFile="~/CRM.Master" AutoEventWireup="true" CodeBehind="DashboardClasses.aspx.cs" Inherits="VendasWeb.Dashboard.DashboardClasses" %>
            ...
            <div class="panel panel-info">
                ...
                <div class="panel-heading">
                    ...
                    <h3 class="panel-title">
                         DashBoard Manuli Fitasa - Classes</h3>
                </div>
                <!--Painel Aberto-->
                    ...
                    <div class="row">
                       ...
                       <div class="col-sm-1">
                            <div class="form-group">
                              <asp:Label ID="LabelClasse" runat="server" Text="Classe:"> </asp:Label>
                            </div>
                        </div>

                        <div class="col-lg-3">
                                <asp:MultiView ID="ClasseMultView" runat="server" ActiveViewIndex="0">
                                    <asp:View ID="ClasseView" runat="server">
                                        <div class="col-lg-5">
