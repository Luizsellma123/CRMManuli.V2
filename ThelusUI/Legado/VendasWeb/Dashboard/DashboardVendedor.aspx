<%@ Page Title="" Language="C#" MasterPageFile="~/CRM.Master" AutoEventWireup="true" CodeBehind="DashboardVendedor.aspx.cs" Inherits="VendasWeb.Dashboard.DashboardPrincipal" %>
            ...
            <div class="panel panel-info">
                ...
                <div class="panel-heading">
                    ...
                    <h3 class="panel-title">
                         DashBoard Manuli Fitasa - Vendedor</h3>
                </div>
                <!--Painel Aberto-->
                ...
                <div class="row">
                    <div class="panel-control">
                        ...
                        <asp:LinkButton ID="GerarLinkButton" class="btn btn-success btn-labeled fa fa-search fa-lg"
                            CausesValidation="false" OnClick="GerarLinkButton_Click1" runat="server">Vendedor</asp:LinkButton>
