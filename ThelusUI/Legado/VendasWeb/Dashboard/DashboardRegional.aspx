<%@ Page Title="" Language="C#" MasterPageFile="~/CRM.Master" AutoEventWireup="true" CodeBehind="DashboardRegional.aspx.cs" Inherits="VendasWeb.Dashboard.DashboardRegional" %>
            ...
            <div class="panel panel-info">
                ...
                <div class="panel-heading">
                    ...
                    <h3 class="panel-title">
                         DashBoard Manuli Fitasa - Regional</h3>
                </div>
                <!--Painel Aberto-->
                    ...
                    <div class="row">
                       ...
                       <div class="col-sm-1">
                            <div class="form-group">
                              <asp:Label ID="LabelClasse" runat="server" Text="Regional:">
                              </asp:Label>
                            </div>
                        </div>

                        <div class="col-lg-3">
                                <asp:MultiView ID="RegionalMultView" runat="server" ActiveViewIndex="0">
                                    <asp:View ID="RegionalView" runat="server">
                                        <div class="col-lg-5">
                                            <select class="selectpicker show-tick" multiple data-placeholder="Escolha uma Regional..."
                                                title="Escolha uma Regional..." data-style="btn-primary" data-live-search="true"
                                                id="RegionalSelect" runat="server">
                                            </select>
                                        </div>
                                    </asp:View>
                                </asp:MultiView>
            ...
            <div class="panel-footer">
                <div class="row">
                    <div class="panel-control">
                        ...
                        <asp:LinkButton ID="LinkButtonVendedor" class="btn btn-success btn-labeled fa fa-search fa-lg"
                            CausesValidation="false" runat="server" OnClick="LinkButtonVendedor_Click" >Vendedor</asp:LinkButton>
