<%@ Page Title="" Language="C#" MasterPageFile="~/NestedMasterPageCRM.master" AutoEventWireup="true" CodeBehind="ContasPagarWebForm.aspx.cs" Inherits="VendasWeb.financeiro.ContasPagarWebForm" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="Head" runat="server">
    ...
    <script language="javascript" src="<%=Page.ResolveClientUrl("~/js/ContasPagarJavaScript.js")%>" type="text/javascript"></script>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div class="row">
        <div class="col-sm-9">
            ...
            <div class="panel panel-info">
                ...
                <div class="panel-heading">
                    ...
                    <h3 class="panel-title">Financeiro - Conta Corrente Clientes - Contas Pagar</h3>
                </div>
                <!--Painel Aberto-->
                ...
                <div class="panel-body">
                    ...
                    <div class="row">
                        <div class="col-sm">
                            <div class="form-group">
                                <b>
                                    <asp:Label ID="ContasPagarLabel" runat="server" Text="Contas Pagar:"></asp:Label>
                                </b>
                            </div>
                        </div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-sm-3">
                            <div class="form-group">
                                <asp:Label ID="PagoLabel" runat="server" Text="Pago:"></asp:Label>
                            </div>
                        </div>

                        <div class="col-sm-3">
                            <div class="form-group">
                                <asp:Label ID="PagoTextoLabel" runat="server"></asp:Label>
                            </div>
                        </div>
                            ...
                            <div class="form-group">
                                <div class="form-group">
                                    <asp:DropDownList ID="OrdenarDropDownList" runat="server" CssClass="form-control">
                                        ...
                                        <asp:ListItem Value="2">Vencimento</asp:ListItem>
                                        <asp:ListItem Value="3">Pagamento</asp:ListItem>
                                    </asp:DropDownList>
                                </div>
                            </div>
                        </div>
        ...
        <%--MULTIVIEW--%>
        <asp:MultiView ID="CCCPagarMultiView" runat="server" ActiveViewIndex="0" Visible="false">
            <asp:View ID="CCCPagarView" runat="server">
                ...
                <div class="panel">
                    ...
                    <div class="panel-body">
                        <div class="table-responsive">
                            <asp:UpdatePanel ID="CCCPagarTesteUpdatePanel" runat="server" UpdateMode="Conditional">
                                <ContentTemplate>
                                    <asp:GridView ID="CCCPagarGridView" EmptyDataText="Não foi possível encontrar nenhuma simulação" AutoGenerateColumns="False"
                                        ...
                                        Style="border-collapse: collapse; max-width: 100%" OnPageIndexChanging="CCCPagarGridView_PageIndexChanging">
                                        ...
                                        <Columns>
                                            ...
                                            <asp:TemplateField HeaderText="Pagamento" ItemStyle-Width="20%">
                                                <ItemTemplate>
                                                    <asp:Label ID="PagamentoLabel" runat="server" Text='<%# Bind("DataPagamento") %>'></asp:Label>
                                                </ItemTemplate>
                                            </asp:TemplateField>

                                            <asp:TemplateField HeaderText="Valor" ItemStyle-Width="20%">
                                                <ItemTemplate>
                                                    <asp:Label ID="ValorLabel" runat="server" Text='<%# String.Format("{0:C}", Convert.ToDouble(Eval("ValorPagar"))) %>'></asp:Label>
                                                </ItemTemplate>
                                            </asp:TemplateField>
