<%@ Page Title="" Language="C#" MasterPageFile="~/NestedMasterPageCRM.master" AutoEventWireup="true" CodeBehind="ContasReceberWebForm.aspx.cs" Inherits="VendasWeb.financeiro.ContasReceberWebForm" %>
        ...
        <div class="col-sm-9">
            ...
            <div class="panel panel-info">
                ...
                <div class="panel-heading">
                    ...
                    <h3 class="panel-title">Financeiro - Conta Corrente Clientes - Contas Receber</h3>
                </div>
                <!--Painel Aberto-->
                            ...
                            <asp:UpdatePanel ID="CCCReceberTesteUpdatePanel" runat="server" UpdateMode="Conditional">
                                <ContentTemplate>
                                    <asp:GridView ID="CCCReceberGridView" EmptyDataText="Não foi possível encontrar nenhuma simulação" AutoGenerateColumns="False"
                                        ...
                                        Style="border-collapse: collapse; max-width: 100%" OnPageIndexChanging="CCCReceberGridView_PageIndexChanging1">
