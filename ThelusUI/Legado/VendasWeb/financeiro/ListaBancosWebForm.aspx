<%@ Page Title="" Language="C#" MasterPageFile="~/NestedMasterPageCRM.master" AutoEventWireup="true" CodeBehind="ListaBancosWebForm.aspx.cs" Inherits="VendasWeb.financeiro.ListaBancosWebForm" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <div class="row">
            ...
            <div class="panel panel-info">
                ...
                <div class="panel-body">
                    <div class="row">
                        ...
                        <div class="col-sm-4">
                            <div class="form-group">
                                <asp:TextBox ID="BancoTextBox" runat="server" CssClass="form-control" placeholder="Nome ou código do banco."></asp:TextBox>
                            </div>
                        </div>
                        ...
                        <div class="col-sm-4">
                            <div class="form-group">
                                <asp:TextBox ID="AgenciaTextBox" runat="server" CssClass="form-control" placeholder="Nome ou código da agência."></asp:TextBox>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-sm-4">
                            <div class="form-group">
                                <div class="form-group">
                                    <asp:TextBox ID="ContaCorrenteTextBox" runat="server" CssClass="form-control" placeholder="Nome ou código da conta."></asp:TextBox>
                                </div>
                            </div>
                        </div>
        ...
        <asp:MultiView ID="BancosMultiView" runat="server" ActiveViewIndex="0" Visible="false">
            <asp:View ID="BancoView" runat="server">
                <!-- TABELA -->
                <!--===================================================-->
                <div class="panel">
                    <div class="panel-heading">
                        <h3 class="panel-title">Lista Bancos
                        </h3>
                    </div>
                    <!-- Foo Table - Filtering -->
                    <!--===================================================-->
                    <div class="panel-body">
                        <div class="table-responsive">
                            ...
                            <asp:GridView ID="BancosGridView" EmptyDataText="Não foi possível encontrar nenhum banco" AutoGenerateColumns="False"
                                ...
                                Style="border-collapse: collapse; max-width: 100%" OnPageIndexChanging="BancosGridView_PageIndexChanging">
