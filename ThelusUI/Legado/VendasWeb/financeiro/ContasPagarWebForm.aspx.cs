...
{
    public partial class ContasPagarWebForm : System.Web.UI.Page
    {
        ...
        protected void CarregaDadosNaTela(object sender, EventArgs e)
        {
            ...
            PagoTextoLabel.Text = OBJClienteClasse.ValorPago.ToString("C");
            MediaAtrasoTextoLabel.Text = OBJClienteClasse.QuantidadeDiasAtrasoAP.ToString();
        }
        ...
        protected void BuscarButton_Click(object sender, EventArgs e)
        {
            ...
            OBJClienteClasse.QuantidadeDiasAtrasoAP = Convert.ToInt32(AtrasoAcimaDropDownList.SelectedValue);
            ...
            OBJDataTable = OBJClienteClasse.RecuperaCCCPagar();
            CCCPagarGridView.DataSource = OBJDataTable;
            CCCPagarGridView.DataBind();
            CCCPagarMultiView.Visible = true;
        }
        ...
        protected void CCCPagarGridView_PageIndexChanging(object sender, GridViewPageEventArgs e)
        {
            CCCPagarGridView.PageIndex = e.NewPageIndex;
