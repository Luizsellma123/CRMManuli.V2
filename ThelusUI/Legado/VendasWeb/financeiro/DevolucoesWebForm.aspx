<%@ Page Title="" Language="C#" MasterPageFile="~/NestedMasterPageCRM.master" AutoEventWireup="true" CodeBehind="DevolucoesWebForm.aspx.cs" Inherits="VendasWeb.financeiro.DevolucoesWebForm" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="Head" runat="server">
    ...
    <script language="javascript" src="<%=Page.ResolveClientUrl("~/js/DevolucoesJavaScript.js")%>" type="text/javascript"></script>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div class="row">
        <div class="col-sm-9">
            ...
            <div class="panel panel-info">
                ...
                <div class="panel-heading">
                    ...
                    <h3 class="panel-title">Financeiro - Conta Corrente Clientes - Devoluções</h3>
                </div>
                <!--Painel Aberto-->
        ...
        <%--MULTIVIEW--%>
        <asp:MultiView ID="CCDevolucoesMultiView" runat="server" ActiveViewIndex="0" Visible="false">
            <asp:View ID="CCDevolucoesView" runat="server">
                ...
                <div class="panel">
                    ...
                    <div class="panel-body">
                        <div class="table-responsive">
                            <asp:UpdatePanel ID="CCDevolucoesTesteUpdatePanel" runat="server" UpdateMode="Conditional">
                                <ContentTemplate>
                                    <asp:GridView ID="CCDevolucoesGridView" EmptyDataText="Não foi possível encontrar nenhuma simulação" AutoGenerateColumns="False"
                                        ...
                                        Style="border-collapse: collapse; max-width: 100%" OnPageIndexChanging="CCDevolucoesGridView_PageIndexChanging">
