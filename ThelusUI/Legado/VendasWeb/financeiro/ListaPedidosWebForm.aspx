<%@ Page Title="" Language="C#" MasterPageFile="~/NestedMasterPageCRM.master" AutoEventWireup="true"
    CodeBehind="ListaPedidosWebForm.aspx.cs" Inherits="VendasWeb.listas.ListaPedidosWebForm" %>
            ...
            <div class="panel panel-info">
                ...
                <div class="panel-body">
                    ...
                    <div class="row">
                        <div class="col-lg-10">
                            <div class="form-group">
                                <asp:Label ID="ProdutosLabel" runat="server" Text="Produtos:" CssClass="texto"></asp:Label>
                                <asp:TextBox ID="ProdutosTextBox" runat="server" CssClass="form-control"></asp:TextBox>
                            </div>
                        </div>
                    </div>
                    %>
                    <%--<div class="row">
                        <asp:MultiView ID="VendedorMultView" runat="server" ActiveViewIndex="0">
                            <asp:View ID="VendedorView" runat="server">
                                <div class="col-lg-10">
                                    <select class="selectpicker show-tick" multiple data-placeholder="Escolha os produtos..."
                                        title="Escolha os produtos..." data-style="btn-primary" data-live-search="true"
                                        id="ProdutosSelect" runat="server" >
                                    </select>
                                </div>
                            </asp:View>
                        </asp:MultiView>
                ...
                <div class="panel">
                    ...
                    <div class="panel-body">
                        <div class="table-responsive">
                            <asp:GridView ID="ListaPedidosGridView" EmptyDataText="Nenhum Pedidos Localizado"
                                ...
                                <Columns>
                                            ...
                                            <asp:UpdatePanel ID="NumeroNotaFiscalUpdatePanel" runat="server" UpdateMode="Conditional">
                                                <ContentTemplate>
                                                    <asp:LinkButton ID="NumeroNotaFiscalLinkButton" runat="server" Text='<%# Bind("NumeroNotaFiscal") %>'
                                                        OnClientClick='<%# string.Format("ConsultaNota("+Eval("IDEmpresa")+","+Eval("NumeroPrimarioNota")+","+Eval("NumeroNotaFiscal")+")")%>'>LinkButton</asp:LinkButton>
                                                </ContentTemplate>
                                                <Triggers>
                                    ...
                                    <asp:TemplateField HeaderStyle-Width="100%" HeaderText="Cópia" Visible="false">
                                        <ItemTemplate>
                                            <contenttemplate>
                                                    <%--<asp:Button ID="btnVerDetalhe" runat="server" Text="Ver Detalhe"
                                                        CssClass="btn btn-danger" OnClick="btnVerDetalhe_Click" />--%>
