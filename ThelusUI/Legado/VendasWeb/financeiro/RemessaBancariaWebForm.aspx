<%@ Page Title="" Language="C#" MasterPageFile="~/NestedMasterPageCRM.master" AutoEventWireup="true" CodeBehind="RemessaBancariaWebForm.aspx.cs" Inherits="VendasWeb.financeiro.RemessaBancariaWebForm" %>

<%@ Register Src="~/usercontrol/FinanceiroBancosRemessasWebUserControl.ascx" TagPrefix="uc1" TagName="FinanceiroBancosRemessasWebUserControl" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
        ...
        <div class="col-sm-9">
            ...
            <div class="panel panel-info">
                ...
                <div class="panel-heading">
                    ...
                    <h3 class="panel-title">Financeiro - Remessa Dados Principais</h3>
                </div>
                <!--Painel Aberto-->
                ...
                <div class="panel-body">
                    ...
                    <div class="row">
                        <div class="col-sm-2">
                            <div class="form-group">
                                <asp:Label ID="NumeroRemessaLabel" runat="server" Text="Numero :"></asp:Label>
                            </div>
                        </div>

                        <div class="col-sm-4">
                            <div class="form-group">
                                <asp:TextBox ID="NumeroRemessaTextBox" runat="server" CssClass="form-control" Enabled="false"></asp:TextBox>
                            </div>
                        </div>
                        ...
                        <div class="col-sm-4">
                            <div class="form-group">
                                <asp:TextBox ID="TotalRemessaTextBox" runat="server" CssClass="form-control" Enabled="false"></asp:TextBox>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-sm-4">
                            <div class="form-group">
                                <asp:TextBox ID="DataTextBox" TextMode="Date" runat="server" CssClass="form-control" Enabled="false"></asp:TextBox>
                            </div>
                        </div>
                        ...
                        <div class="col-sm-4">
                            <div class="form-group">
                                <asp:DropDownList ID="StatusDropDownList" runat="server" CssClass="form-control" Enabled="false"></asp:DropDownList>
                            </div>
                        </div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-sm-4">
                            <div class="form-group">
                                <asp:DropDownList ID="BancoDropDownList" runat="server" CssClass="form-control" AutoPostBack="true" OnSelectedIndexChanged="BancoDropDownList_SelectedIndexChanged"></asp:DropDownList>
                            </div>
                        </div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-sm-4">
                            <div class="form-group">
                                <asp:DropDownList ID="AgenciaDropDownList" runat="server" CssClass="form-control" AutoPostBack="true" OnSelectedIndexChanged="AgenciaDropDownList_SelectedIndexChanged"></asp:DropDownList>
                            </div>
                        </div>
                        ...
                        <div class="col-sm-4">
                            <div class="form-group">
                                <div class="form-group">
                                    <asp:DropDownList ID="ContaCorrenteDropDownList" runat="server" CssClass="form-control"></asp:DropDownList>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="panel-control">
                        <asp:UpdatePanel ID="TesteUpdatePanel" runat="server" UpdateMode="Conditional">
                            <ContentTemplate>
                                ...
                                &nbsp;&nbsp;<asp:LinkButton ID="GravarRemessaButton" class="btn btn-success btn-labeled fa fa-save fa-lg"
                                    CausesValidation="false" runat="server" OnClick="GravarRemessaButton_Click">Gravar</asp:LinkButton>
                            </ContentTemplate>
                            <Triggers>
                                <asp:PostBackTrigger ControlID="GravarRemessaButton" />
                            </Triggers>
                        </asp:UpdatePanel>
                    </div>
                </div>
    ...
    <uc1:FinanceiroBancosRemessasWebUserControl runat="server" ID="FinanceiroBancosRemessasWebUserControl" />
