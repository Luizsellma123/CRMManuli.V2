    ...
    public partial class cadPedidoListaArte : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (!IsPostBack)
            {
                ...
                {
                    idexItem = (int)Convert.ToInt32(mdlCriptografia.Descriptografar(Request.QueryString["idexItem"].ToString(), "#!$a36?@"));
        ...
        public void carregaCabecario()
        {
            ...
            int idexItem =(int)Convert.ToInt32(Session["idexItem"]);
        ...
        {
            int auxItem =(int)Convert.ToInt32(Session["idexItem"]);
            int idRemove = (int)Convert.ToInt32(idItem);
