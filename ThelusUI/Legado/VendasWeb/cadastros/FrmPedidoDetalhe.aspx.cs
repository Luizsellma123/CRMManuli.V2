    ...
    public partial class FrmPedidoDetalhe : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (!IsPostBack)
            {
                ...
                //Se cliente estiver no STATUS Cliente está em análise, não permite acesso ao pedido
                if(PedidoClass.IDStatusCliente == 4 || PedidoClass.IDStatusCliente == 5)
                {
                    AcessarButton.Visible = false;
                }
        ...
        protected void HistoricoLinkButton_Click(object sender, EventArgs e)
        {
            ...
            Response.Redirect("../cadastros/PedidoHistoricoWebForm.aspx?indmnu=5");
        }
    }
}