<%@ Page Title="" Language="C#" MasterPageFile="~/NestedMasterPageCRM.master" AutoEventWireup="true" CodeBehind="cadPedidoPrincipal.aspx.cs" Inherits="VendasWeb.cadastros.cadPedidoPrincipal" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    ...
    <%-- MUDADO PRA AUX=6 --%>
    <script language="javascript" src="../js/cadPedidoPrincipal1.js?aux=6" type="text/javascript"></script>
    <style type="text/css">
        .style1 {
            width: 129px;
        }
    ...
    <div class="row">
        ...
        <asp:Label ID="lblDescNumPedido"  runat="server" Text="" CssClass="text-thin"></asp:Label><br /> -->
                    ...
                    <div>
                        <div class="row">
                            ...
                            <div class="col-xs-3">
                                ...
                                <asp:TextBox ID="txtDataEntrega" runat="server" Width="80%" TextMode="Date"
                            ...
                            <div class="col-xs-3">
                                <h5>
                                    <asp:Label ID="lblDataEmissao" runat="server" Text="Data Emissão:" CssClass="text-thin"></asp:Label>
                                </h5>

                                <asp:TextBox ID="txtDataEmissao" CssClass="form-control" runat="server" ReadOnly="true"></asp:TextBox>
                            </div>
                            ...
                            <div class="col-sm-3">
                                ...
                                <asp:TextBox ID="txtPedCliente" runat="server" CssClass="form-control" ReadOnly="false" Width="90%" MaxLength="40"></asp:TextBox>
                            </div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-sm-3">
                            <h5>
                                <asp:Label ID="Label1" runat="server" Text="Destinação:" CssClass="text-thin"></asp:Label></h5>
                            <div style="margin-right: 1px; margin-top: 1px; float: right;">
                                <h4>
                                    <a href="#" id="btnUtilizacao">
                                        <i class="fa fa-industry"></i></a>
                                </h4>
                            </div>

                            <asp:DropDownList ID="drpDestinacao" runat="server" CssClass="form-control" Width="90%">
                            </asp:DropDownList>
                        </div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-sm-3">
                            ...
                            <asp:DropDownList ID="drpTipoFrete" OnSelectedIndexChanged="drpTipoFrete_SelectedIndexChanged"
                                AutoPostBack="true" runat="server" CssClass="form-control">
                                <asp:ListItem Value="3">Emitente</asp:ListItem>
                                <asp:ListItem Value="1">Destinatário</asp:ListItem>
                                <asp:ListItem Value="5">Retira</asp:ListItem>
                            </asp:DropDownList>
                        </div>
