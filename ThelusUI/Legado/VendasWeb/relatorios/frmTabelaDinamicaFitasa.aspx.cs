...
{
    public partial class frmTabelaDinamicaFitasa : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (!IsPostBack)
            {
                ...
                dadosTable = mdlRelatorios.relatorioTabelaDinamicaFitasa(Session["empresa"].ToString(), Session["natureza"].ToString(), Session["produto"].ToString(),
                ...
                rptDados.Name = "dtTabelaDinamicaFaturados";
