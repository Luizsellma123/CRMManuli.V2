...
{
    public partial class frmTabelaDinamica : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (!IsPostBack)
            {
                ...
                dadosTable = mdlRelatorios.relatorioTabelaDinamica(Session["empresa"].ToString(), Session["natureza"].ToString(), Session["produto"].ToString(),
                ...
                rptDados.Name = "dtTabelaDinamica";
                rptDados.DataMember = "USER_SP_SelecionatabelaDinamica";
