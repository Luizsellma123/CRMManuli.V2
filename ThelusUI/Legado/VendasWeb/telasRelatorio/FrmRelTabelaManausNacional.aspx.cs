...
{
    public partial class FrmRelTabelaManausNacional : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (!IsPostBack)
            {
                ...
                tabListaUser = ObjclasRelatorios.relatorioTabelaPrecoManausNacional();

                ReportDataSource.Name = "USER_SP_REL_TABELA_PRECO_MANAUS_NACIONAL";
                ReportDataSource.DataMember = "USER_SP_REL_TABELA_PRECO_MANAUS_NACIONAL";
