<%@ Page Title="" Language="C#" MasterPageFile="~/NestedMasterPageCRM.master" AutoEventWireup="true" CodeBehind="DiscosWebForm.aspx.cs" Inherits="VendasWeb.Infraestrutura.DiscosWebForm" %>
                            ...
                            <asp:GridView ID="InfraestruturaGridView" EmptyDataText="Não foi possível encontrar nenhum chamado." AutoGenerateColumns="False"
                                ...
                                <Columns>                                                                      
                                    ...
                                    <asp:TemplateField HeaderText="Nome">
                                        <ItemTemplate>
                                            <asp:Label ID="NomeLabel" runat="server" Text='<%# Bind("NomeDisco") %>'></asp:Label>
                                        </ItemTemplate>
                                    </asp:TemplateField>

                                    <asp:TemplateField HeaderText="Armazenamento Total">
                                        <ItemTemplate>
                                            <asp:Label ID="ArmazenamentoTotalLabel" runat="server" Text='<%# Bind("ArmazenamentoTotal") %>'></asp:Label>
                                        </ItemTemplate>
                                    </asp:TemplateField>

                                    <asp:TemplateField HeaderText="Armazenamento Usado">
                                        <ItemTemplate>
                                            <asp:Label ID="ArmazenamentoUsadoLabel" runat="server" Text='<%# Bind("ArmazenamentoUsado") %>'></asp:Label>
                                        </ItemTemplate>
                                    </asp:TemplateField>

                                    <asp:TemplateField HeaderText="Tipo">
                                        <ItemTemplate>
                                            <asp:Label ID="TipoLabel" runat="server" Text='<%# Bind("Tipo") %>'></asp:Label>
                                        </ItemTemplate>
                                    </asp:TemplateField>
