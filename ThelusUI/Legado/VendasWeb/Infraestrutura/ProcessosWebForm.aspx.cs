...
{
    public partial class ProcessosWebForm : System.Web.UI.Page
    {
        ...
        protected void AtualizarButton_Click(object sender, EventArgs e)
        {
            if (Session["objInfraestruturaClass"] != null)
            {
                ...
                DataTable InfraestruturaDataTable = objInfraestruturaClass.CarregaProcessosMaquina(NomeProcessoTextBox.Text);
