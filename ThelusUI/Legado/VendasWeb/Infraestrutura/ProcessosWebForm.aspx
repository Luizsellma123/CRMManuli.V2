<%@ Page Title="" Language="C#" MasterPageFile="~/NestedMasterPageCRM.master" AutoEventWireup="true" CodeBehind="ProcessosWebForm.aspx.cs" Inherits="VendasWeb.Infraestrutura.ProcessosWebForm" %>
    ...
    <div class="row">
                ...
                <div class="panel-body">
                    ...
                    <div class="row">                        
                     ...
                     <div class="row">                        
                        ...
                        <div class="col-sm-2">
                            <div class="form-group">
                                <asp:Label runat="server" Text="Nome do processo:"></asp:Label>
                            </div>
                        </div>

                        <div class="col-sm-10">
                            <div class="form-group">
                                <asp:TextBox ID="NomeProcessoTextBox" runat="server" CssClass="form-control"></asp:TextBox>
                            </div>
                        </div>                      
                ...
                <div class="row">
                    ...
                    <div class="panel-control">
                        ...
                        <asp:LinkButton ID="AtualizarButton" class="btn btn-primary btn-labeled fa fa-refresh fa-lg"
                            CausesValidation="false" runat="server" OnClick="AtualizarButton_Click">Atualizar \ Buscar</asp:LinkButton>
        ...
        <asp:MultiView ID="InfraestruturaMultiView" runat="server" ActiveViewIndex="0" Visible="false">
            <asp:View ID="InfraestruturaView" runat="server">
                ...
                <div class="panel">
                    <div class="panel-heading">
                        <h3 class="panel-title">Lista Discos
                        </h3>
                    </div>
                    <!-- Foo Table - Filtering -->
                    <!--===================================================-->
                            ...
                            <asp:GridView ID="InfraestruturaGridView" EmptyDataText="Não foi possível encontrar nenhum chamado." AutoGenerateColumns="False"
                                ...
                                <Columns>                                                                      
                                    ...
                                    <asp:TemplateField HeaderText="Nome">
                                        <ItemTemplate>
                                            <asp:Label ID="NomeLabel" runat="server" Text='<%# Bind("NomeProcesso") %>'></asp:Label>
                                        </ItemTemplate>
                                    </asp:TemplateField>

                                    <asp:TemplateField HeaderText="Memoria Usada">
                                        <ItemTemplate>
                                            <asp:Label ID="MemoriaUsadaLabel" runat="server" Text='<%# Bind("MemoriaUsada") %>'></asp:Label>
                                        </ItemTemplate>
                                    </asp:TemplateField>

                                    <asp:TemplateField HeaderText="Inicio da execução">
                                        <ItemTemplate>
                                            <asp:Label ID="DataInicioExecucaoLabel" runat="server" Text='<%# Bind("DataInicioExecucao") %>'></asp:Label>
                                        </ItemTemplate>
                                    </asp:TemplateField>                                  
