<%@ Page Title="" Language="C#" MasterPageFile="~/NestedMasterPageCRM.master" AutoEventWireup="true" CodeBehind="AnaliseCreditoGrafiasSemelhantesWebForm.aspx.cs" Inherits="VendasWeb.Clientes.AnaliseCreditoGrafiasSemelhantesWebForm" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div class="row">
        <div class="col-sm-9">
            ...
            <div class="panel panel-info">
                ...
                <div class="panel-heading">
                    ...
                    <h3 class="panel-title">Cadastro Cliente - Análise Crédito - Grafias Semelhantes</h3>
                </div>
                <!--Painel Aberto-->
                ...
                <div class="panel-body">
                    ...
                    <div>
                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-2">
                                <div class="form-group">
                                    <asp:Label runat="server" Text="Grafias.:"></asp:Label>
                                </div>
                            </div>

                            <div class="col-sm-10">
                                <div class="form-group">
                                    <asp:TextBox ID="GrafiasTextBox" class="form-control" runat="server" Enabled="false"></asp:TextBox>
                                </div>
                            </div>
        ...
        <asp:MultiView ID="GrafiasSemelhantesMultiView" runat="server" ActiveViewIndex="0" Visible="false">
            <asp:View ID="GrafiasSemelhantesView" runat="server">
                <div class="panel">
                    <%--<div class="panel-heading">
                    ...
                    <div class="panel-body">
                        <div class="table-responsive">
                            ...
                            <asp:GridView ID="GrafiasSemelhantesGridView" EmptyDataText="Não foi possível encontrar nenhuma simulação"
                                AutoGenerateColumns="False" runat="server" AllowPaging="True" Style="border-collapse: collapse; max-width: 100%"
                                OnPageIndexChanging="GrafiasSemelhantesGridView_PageIndexChanging" Visible="true"
                                ...
                                <Columns>
                                    ...
                                    <asp:TemplateField HeaderText="Grafia">
                                        <ItemTemplate>
                                            <center>
                                                <asp:Label ID="GrafiaLabel" runat="server" Text='<%# Bind("Grafia") %>'></asp:Label>
                                            </center>
                                        </ItemTemplate>
