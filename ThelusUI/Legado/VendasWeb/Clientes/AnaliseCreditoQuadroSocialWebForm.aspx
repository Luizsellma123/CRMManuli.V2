<%@ Page Title="" Language="C#" MasterPageFile="~/NestedMasterPageCRM.master" AutoEventWireup="true" CodeBehind="AnaliseCreditoQuadroSocialWebForm.aspx.cs" Inherits="VendasWeb.Clientes.AnaliseCreditoQuadroSocialWebForm" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div class="row">
        <div class="col-sm-9">
            ...
            <div class="panel panel-info">
                ...
                <div class="panel-heading">
                    ...
                    <h3 class="panel-title">Cadastro Cliente - Análise Crédito - Quadro Social</h3>
                </div>
                <!--Painel Aberto-->
        ...
        <asp:MultiView ID="QuadroSocialMultiView" runat="server" ActiveViewIndex="0" Visible="false">
            <asp:View ID="QuadroSocialView" runat="server">
                <div class="panel">
                    <%--<div class="panel-heading">
                    ...
                    <div class="panel-body">
                        <div class="table-responsive">
                            ...
                            <asp:GridView ID="QuadroSocialGridView" EmptyDataText="Não foi possível encontrar nenhuma simulação"
                                AutoGenerateColumns="False" runat="server" AllowPaging="True" Style="border-collapse: collapse; max-width: 100%"
                                OnPageIndexChanging="QuadroSocialGridView_PageIndexChanging" Visible="true"
                                ...
                                <Columns>
                                    ...
                                    <asp:BoundField HeaderText="Sócio/Acionista" DataField="SocioAcionista" />

                                    <asp:BoundField HeaderText="Entrada" DataField="Entrada" />

                                    <asp:BoundField HeaderText="Nacionalidade" DataField="Nacionalidade" />

                                    <asp:BoundField HeaderText="Votante" DataField="Votante" />
