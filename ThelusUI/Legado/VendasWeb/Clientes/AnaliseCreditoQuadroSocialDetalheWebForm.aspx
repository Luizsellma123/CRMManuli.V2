<%@ Page Title="" Language="C#" MasterPageFile="~/NestedMasterPageCRM.master" AutoEventWireup="true" CodeBehind="AnaliseCreditoQuadroSocialDetalheWebForm.aspx.cs" Inherits="VendasWeb.Clientes.AnaliseCreditoQuadroSocialDetalheWebForm" %>
        ...
        <div class="col-sm-9">
            ...
            <div class="panel panel-info">
                ...
                <div class="panel-heading">
                    ...
                    <h3 class="panel-title">Cadastro Cliente - Análise Crédito - Quadro Social - Detalhe</h3>
                </div>
                <!--Painel Aberto-->
                ...
                <div class="panel-body">
                    ...
                    <div>
                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-2">
                                <div class="form-group">
                                    <asp:Label runat="server" Text="Sócio:"></asp:Label>
                                </div>
                            </div>

                            <div class="col-sm-10">
                                <div class="form-group">
                                    <asp:TextBox ID="SocioTextBox" class="form-control" runat="server" Enabled="false"></asp:TextBox>
                                </div>
                            </div>
                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-2">
                                <div class="form-group">
                                    <asp:Label runat="server" Text="Capital Votante:"></asp:Label>
                                </div>
                            </div>

                            <div class="col-sm-4">
                                <div class="form-group">
                                    <asp:TextBox ID="CapitalVotanteTextBox" class="form-control" runat="server" Enabled="false"></asp:TextBox>
                                </div>
                            </div>
                            ...
                            <div class="col-sm-4">
                                <div class="form-group">
                                    <asp:TextBox ID="TotalTextBox" class="form-control" runat="server" Enabled="false"></asp:TextBox>
                                </div>
                            </div>
