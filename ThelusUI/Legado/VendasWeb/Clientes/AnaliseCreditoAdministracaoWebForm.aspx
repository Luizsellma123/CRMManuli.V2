<%@ Page Title="" Language="C#" MasterPageFile="~/NestedMasterPageCRM.master" AutoEventWireup="true" CodeBehind="AnaliseCreditoAdministracaoWebForm.aspx.cs" Inherits="VendasWeb.Clientes.AnaliseCreditoAdministracaoWebForm" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div class="row">
        <div class="col-sm-9">
            ...
            <div class="panel panel-info">
                ...
                <div class="panel-heading">
                    ...
                    <h3 class="panel-title">Cadastro Cliente - Análise Crédito - Administracao</h3>
                </div>
                <!--Painel Aberto-->
                ...
                <div class="panel-body">
                    ...
                    <div>
                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-2">
                                <div class="form-group">
                                    <asp:Label runat="server" Text="Capital Social:"></asp:Label>
                                </div>
                            </div>

                            <div class="col-sm-4">
                                <div class="form-group">
                                    <asp:TextBox ID="CapitalSocialTextBox" class="form-control" runat="server" Enabled="false"></asp:TextBox>
                                </div>
                            </div>
                        ...
                        <%-- Origem, Controle, Natureza --%>
                        <div class="row">

                            <div class="col-sm-2">
                                <div class="form-group">
                                    <asp:Label runat="server" Text="Origem:"></asp:Label>
                                </div>
                            </div>

                            <div class="col-sm-2">
                                <div class="form-group">
                                    <asp:TextBox ID="OrigemTextBox" class="form-control" runat="server" Enabled="false"></asp:TextBox>
                                </div>
                            </div>

                            <div class="col-sm-2">
                                <div class="form-group">
                                    <asp:Label runat="server" Text="Controle:"></asp:Label>
                                </div>
                            </div>

                            <div class="col-sm-2">
                                <div class="form-group">
                                    <asp:TextBox ID="ControleTextBox" class="form-control" runat="server" Enabled="false"></asp:TextBox>
                                </div>
                            </div>

                            <div class="col-sm-2">
                                <div class="form-group">
                                    <asp:Label runat="server" Text="Natureza:"></asp:Label>
                                </div>
                            </div>

                            <div class="col-sm-2">
                                <div class="form-group">
                                    <asp:TextBox ID="NaturezaTextBox" class="form-control" runat="server" Enabled="false"></asp:TextBox>
                                </div>
                            </div>
        ...
        <asp:MultiView ID="AdministracaoMultiView" runat="server" ActiveViewIndex="0" Visible="false">
            <asp:View ID="AdministracaoView" runat="server">
                <div class="panel">
                    <%--<div class="panel-heading">
                    ...
                    <div class="panel-body">
                        <div class="table-responsive">
                            ...
                            <asp:GridView ID="AdministracaoGridView" EmptyDataText="Não foi possível encontrar nenhuma simulação"
                                AutoGenerateColumns="False" runat="server" AllowPaging="True" Style="border-collapse: collapse; max-width: 100%"
                                OnPageIndexChanging="AdministracaoGridView_PageIndexChanging" Visible="true"
                                ...
                                <Columns>
                                    ...
                                    <asp:TemplateField HeaderText="CPF/CNPJ">
                                        <ItemTemplate>
                                            <center>
                                                <asp:Label ID="CPFCNPJLabel" runat="server" Text='<%# Bind("CPFCNPJ") %>'></asp:Label>
                                            </center>
                                        </ItemTemplate>
                                    </asp:TemplateField>

                                    <asp:BoundField HeaderText="Administração" DataField="Administracao" />
                                    ...
                                    <asp:BoundField HeaderText="Mandato" DataField="Mandato" />

                                    <asp:BoundField HeaderText="Anotações" DataField="Anotacoes" />
