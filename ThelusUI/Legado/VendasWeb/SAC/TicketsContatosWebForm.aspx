<%@ Page Title="" Language="C#" MasterPageFile="~/NestedMasterPageCRM.master" AutoEventWireup="true" CodeBehind="TicketsContatosWebForm.aspx.cs" Inherits="VendasWeb.SAC.TicketsContatosWebForm" %>
        ...
        <div class="col-sm-9">
            ...
            <div class="panel panel-info">
                ...
                <div class="panel-heading">
                    ...
                    <h3 class="panel-title">SAC - Ticket's - Contatos</h3>
                </div>
                <!--Painel Aberto-->
                ...
                <div class="panel-body">
                    ...
                    <div class="row">
                        ...
                        <div class="col-sm-2">
                            <div class="form-group">
                                <asp:Label ID="PessoaLabel" runat="server" Text="Pessoa:"></asp:Label>
                            </div>
                        </div>

                        <div class="col-sm-10">
                            <div class="form-group">
                                <asp:TextBox ID="PessoaTextBox" runat="server" CssClass="form-control"
                    ...
                    <div class="row">
                        ...
                        <div class="col-sm-5">
                            <div class="form-group">
                                <asp:TextBox ID="EmailTextBox" runat="server" CssClass="form-control"
                                    placeholder="Informar o email."></asp:TextBox>
                            </div>
                        </div>
                        ...
                        <div class="col-sm-3">
                            <div class="form-group">
                                <asp:TextBox ID="TelefoneTextBox" runat="server" CssClass="form-control"
                                    onkeypress="mascara( this, mtel );" onblur="mascara( this, mtel );" onfocus="mascara( this, mtel );"
                                    placeholder="Informar o número.">
                                </asp:TextBox>
                            </div>
                        </div>
                            ...
                            <asp:GridView ID="SACGridView" EmptyDataText="Não foi possível encontrar nenhuma simulação" AutoGenerateColumns="False"
                                ...
                                <Columns>
                                    ...
                                    <asp:TemplateField HeaderText="Contato">
                                        <ItemTemplate>
                                            <asp:Label ID="ContatoLabel" runat="server" Text='<%# Bind("Contato") %>'></asp:Label>
                                        </ItemTemplate>
                                    </asp:TemplateField>
