...
{
    public partial class TicketsSACWebForm : System.Web.UI.Page
    {
        ...
        protected void CarregaDadosNaTela()
        {
            ...
            SACGridView.DataSource = ObjSAC.RetornaListaSituacaoTickets();
        ...
        protected void EditarLinkButton_Click(object sender, EventArgs e)
        {
            ...
            Session["SituacaoTicketsDetalhe"] = ObjSAC;
            Response.Redirect("~/SAC/SituacaoTicketsDetalheWebForm.aspx?indmnu=5");
        }
