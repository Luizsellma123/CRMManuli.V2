...
{
    public partial class SituacaoTicketsDetalheWebForm : System.Web.UI.Page
    {
        ...
        {
            if (Session["SituacaoTicketsDetalhe"] != null)
            {
                ObjSAC = (SACClass)Session["SituacaoTicketsDetalhe"];
            }
            ...
            if (ObjSAC.Operacao == "Alteracao")
            {
                ...
                ObjSAC.Tela = "Detalhe";
                SACDataTable = ObjSAC.RetornaListaSituacaoTickets();
        ...
        protected void SalvarLinkButton_Click(object sender, EventArgs e)
        {
            ...
            if (erro == "")
            {
                erro = ObjSAC.GravaSituacaoTickets();
            }
