<%@ Page Title="" Language="C#" MasterPageFile="~/NestedMasterPageCRM.master" AutoEventWireup="true" CodeBehind="CadastroSolucaoWebForm.aspx.cs" Inherits="VendasWeb.SAC.CadastroSolucaoWebForm" %>
        ...
        <div class="col-sm-9">
            ...
            <div class="panel panel-info">
                ...
                <div class="panel-heading">
                    ...
                    <h3 class="panel-title">SAC - Soluções</h3>
                </div>
                <!--Painel Aberto-->
                    ...
                    <div class="row">
                        ...
                        <div class="col-sm-2">
                            <div class="form-group">
                                <asp:Label ID="SolucaoLabel" runat="server" Text="Solucão:"></asp:Label>
                            </div>
                        </div>

                        <div class="col-sm-10">
                            <div class="form-group">
                                <asp:TextBox ID="SolucaoTextBox" runat="server" CssClass="form-control"
            ...
            <div class="panel-footer">
                <div class="row">
                    <div class="panel-control">
                        ...
                        <asp:LinkButton ID="NovaSolucaoLinkButton" class="btn btn-success btn-labeled fa fa-plus-circle fa-lg"
                            CausesValidation="false" runat="server" OnClick="NovaSolucaoLinkButton_Click">Nova Solução</asp:LinkButton>
                            ...
                            <asp:GridView ID="SACGridView" EmptyDataText="Não foi possível encontrar nenhuma simulação" AutoGenerateColumns="False"
                                ...
                                <Columns>
                                    ...
                                    <asp:TemplateField HeaderText="Código">
                                        <ItemTemplate>
                                            <asp:Label ID="CodigoLabel" runat="server" Text='<%# Bind("IDSolucao") %>'></asp:Label>
                                        </ItemTemplate>
                                        <HeaderStyle Width="10px" />
                                    </asp:TemplateField>
