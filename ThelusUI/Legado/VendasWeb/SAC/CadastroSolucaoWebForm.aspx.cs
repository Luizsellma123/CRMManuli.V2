...
{
    public partial class CadastroSolucaoWebForm : System.Web.UI.Page
    {
        ...
        {
            ObjSAC.Solucao = SolucaoTextBox.Text;

            SACGridView.DataSource = ObjSAC.RetornaListaSolucoes();
            SACGridView.DataBind();
            SACMultiView.Visible = true;
        }

        protected void NovaSolucaoLinkButton_Click(object sender, EventArgs e)
        {
            Session["CadastroSolucao"] = null;
            Response.Redirect("~/SAC/CadastroSolucaoDetalheWebForm.aspx?indmnu=5");
        }

        protected void EditarLinkButton_Click(object sender, EventArgs e)
        {
            ObjSAC.Operacao = "Alteracao";
            ObjSAC.IDSolucao = Convert.ToInt32(((Label)((Control)sender).FindControl("CodigoLabel")).Text);
            Session["CadastroSolucao"] = ObjSAC;
            Response.Redirect("~/SAC/CadastroSolucaoDetalheWebForm.aspx?indmnu=5");
        }
        ...
        protected void PadraoCheckBox_CheckedChanged(object sender, EventArgs e)
        {
            ...
            ApresentaMensagem(ObjSAC.GravaSolucaoPadrao());
