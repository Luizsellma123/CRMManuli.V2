<%@ Page Title="" Language="C#" MasterPageFile="~/NestedMasterPageCRM.master" AutoEventWireup="true" CodeBehind="CadastroMotivoWebForm.aspx.cs" Inherits="VendasWeb.SAC.CadastroMotivoWebForm" %>
        ...
        <div class="col-sm-9">
            ...
            <div class="panel panel-info">
                ...
                <div class="panel-heading">
                    ...
                    <h3 class="panel-title">SAC - Motivos</h3>
                </div>
                <!--Painel Aberto-->
                ...
                <div class="panel-body">
                    ...
                    <div class="row">
                        ...
                        <div class="col-sm-11">
                            <div class="form-group">
                                <asp:TextBox ID="MotivoTextBox" runat="server" CssClass="form-control"
            ...
            <div class="panel-footer">
                <div class="row">
                    <div class="panel-control">
                        ...
                        <asp:LinkButton ID="NovoMotivoLinkButton" class="btn btn-success btn-labeled fa fa-plus-circle fa-lg"
                            CausesValidation="false" runat="server" OnClick="NovoMotivoLinkButton_Click">Novo Motivo</asp:LinkButton>
                            ...
                            <asp:GridView ID="SACGridView" EmptyDataText="Não foi possível encontrar nenhuma simulação" AutoGenerateColumns="False"
                                ...
                                <Columns>
                                    ...
                                    <asp:TemplateField HeaderText="Código">
                                        <ItemTemplate>
                                            <asp:Label ID="CodigoLabel" runat="server" Text='<%# Bind("IDMotivo") %>'></asp:Label>
                                        </ItemTemplate>
                                        <HeaderStyle Width="10px" />
                                    </asp:TemplateField>
