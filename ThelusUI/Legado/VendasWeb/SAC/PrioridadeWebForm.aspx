<%@ Page Title="" Language="C#" MasterPageFile="~/NestedMasterPageCRM.master" AutoEventWireup="true" CodeBehind="PrioridadeWebForm.aspx.cs" Inherits="VendasWeb.SAC.PrioridadeWebForm" %>
        ...
        <div class="col-sm-9">
            ...
            <div class="panel panel-info">
                ...
                <div class="panel-heading">
                    ...
                    <h3 class="panel-title">SAC - Prioridades</h3>
                </div>
                <!--Painel Aberto-->
                    ...
                    <div class="row">
                        <div class="col-sm-2">
                            <div class="form-group">
                                <asp:Label ID="PrioridadesLabel" runat="server" Text="Prioridades:"></asp:Label>
                            </div>
                        </div>
                        ...
                        <div class="col-sm-10">
                            <div class="form-group">
                                <div class="form-group">
                                    <asp:TextBox ID="PrioridadesTextBox" runat="server" CssClass="form-control"
                ...
                <div class="panel">
                    ...
                    <div class="panel-body">
                        <div class="table-responsive">
                            ...
                            <asp:UpdatePanel ID="SACGridViewUpdatePanel" runat="server" UpdateMode="Conditional" AutoPostBack="true">
                                <ContentTemplate>
                                    ...
                                    <asp:GridView ID="SACGridView" EmptyDataText="Não foi possível encontrar nenhuma simulação" AutoGenerateColumns="False"
                                        ...
                                        <Columns>
                                            ...
                                            <asp:TemplateField HeaderText="Padrão">
                                                <ItemTemplate>
                                                    <center>
                                                        <asp:CheckBox ID="PadraoCheckBox"
                                                            runat="server" Checked='<%# Convert.ToBoolean(Eval("Padrao")) %>'
                                ...
                                <%--  <Triggers>
                                    <asp:PostBackTrigger ControlID="SACGridViewUpdatePanel" />
                                </Triggers>--%>
                            </asp:UpdatePanel>
