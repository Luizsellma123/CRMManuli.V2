<%@ Page Title="" Language="C#" MasterPageFile="~/NestedMasterPageCRM.master" AutoEventWireup="true" CodeBehind="CadastroTipoOcorrenciaDetalheWebForm.aspx.cs" Inherits="VendasWeb.SAC.CadastroTipoOcorrenciaDetalheWebForm" %>
        ...
        <div class="col-sm-9">
            ...
            <div class="panel panel-info">
                ...
                <div class="panel-heading">
                    ...
                    <h3 class="panel-title">SAC - Tipo Ocorrência - Detalhe</h3>
                </div>
                <!--Painel Aberto-->
                ...
                <div class="panel-body">
                    ...
                    <div class="row">
                        ...
                        <div class="col-sm-4">
                            <div class="form-group">
                                <div class="form-group">
                                    <asp:TextBox class="form-control" ID="CodigoTextBox" Enabled="false" runat="server"></asp:TextBox>
                                </div>
                            </div>
                        </div>
