...
(function(t) {
    ...
    function me(n, r) {
        ...
        function a() {
            ...
            ie && n.prepend(ie),
            c(J.defaultView),
            J.handleWindowResize && (ae = G(w, J.windowResizeDelay),
            t(window).resize(ae))
        }
        function u() {
            oe && oe.destroyView(),
        ...
        function c(e) {
            ge++,
            oe && e && oe.type !== e && (ne.deactivateButton(oe.type),
            W(),
            ...
            ne.activateButton(e)),
            oe && (ue = oe.massageCurrentDate(ue),
            oe.start && ue.isWithin(oe.intervalStart, oe.intervalEnd) || d() && (W(),
            oe.start && oe.destroyView(),
            oe.setDate(ue),
            oe.renderView(),
            j(),
        ...
        function S() {
            d() && (W(),
            oe.destroyViewEvents(),
            oe.renderViewEvents(pe),
            j())
        }
        function C() {
            W(),
        ...
        function z(t, e) {
            t = K.moment(t),
            e = e ? K.moment(e) : t.hasTime() ? t.clone().add(K.defaultTimedEventDuration) : t.clone().add(K.defaultAllDayEventDuration),
            oe.select({
                start: t,
                end: e
            })
        ...
        function V() {
            ue = oe.computePrevDate(ue),
            c()
        }
        function _() {
            ue = oe.computeNextDate(ue),
            c()
        }
        function A() {
            ue.add(-1, "years"),
        ...
        function U(t, e) {
            return void 0 === e ? J[t] : (("height" == t || "contentHeight" == t || "aspectRatio" == t) && (J[t] = e,
            m(!0)),
            void 0)
        }
        function q(t, e) {
        ...
        var te = x(s(J.lang));
        if (J.monthNames && (te._months = J.monthNames),
        ...
        K.moment = function() {
            var t;
            return "local" === J.timezone ? (t = De.moment.apply(null , arguments),
            t.hasTime() && t.local()) : t = "UTC" === J.timezone ? De.moment.utc.apply(null , arguments) : De.moment.parseZone.apply(null , arguments),
        ...
        K.getDefaultEventEnd = function(t, e) {
            var n = e.clone();
            return t ? n.stripTime().add(K.defaultAllDayEventDuration) : n.add(K.defaultTimedEventDuration),
    ...
    var qe = De.View = K.extend({
        ...
        massageCurrentDate: function(t, n) {
            return this.intervalDuration <= e.duration({
                days: 1
            }) && this.isHiddenDay(t) && (t = this.skipHiddenDays(t, n),
            t.startOf("day")),
            t
        },
