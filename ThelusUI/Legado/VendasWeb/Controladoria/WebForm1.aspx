<%@ Page Title="" Language="C#" MasterPageFile="~/CRM.Master" AutoEventWireup="true" CodeBehind="WebForm1.aspx.cs" Inherits="VendasWeb.Controladoria.WebForm1" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <div class="row">
            ...
            <div class="panel panel-info">
                ...
                <div class="panel-body">
                    ...
                    <div class="row">
                        ...
                        <div class="col-sm-10">
                            <h5>
                                <asp:Label ID="StatusEntidadeLabel" runat="server" Text="Carga Planilha:" CssClass="text-thin"></asp:Label></h5>
                                <asp:FileUpload ID="FileUploadArquivo" runat="server" class="filestyle" style="background: blue;" />
                        </div>
                    </div>
                    <hr />
                </div>
                ...
                <div class="row">
                    <div class="panel-control">
                        <asp:LinkButton ID="btnListar" class="btn btn-success btn-labeled fa fa-search fa-lg"
                            ...
                            CausesValidation="False" OnClick="btnListar_Click"> 
             Lista Planilha </asp:LinkButton>

                        <asp:LinkButton ID="LinkButton1" class="btn btn-success btn-labeled fa fa-search fa-lg"
                            runat="server" title="Buscar Cliente" data-rel="tooltip"
                            CausesValidation="False" OnClick="LinkButton1_Click"> 
             Grava Documento </asp:LinkButton>
                    </div>
                </div>
            </div>
        <%--</div>--%>
        ...
        <!--===================================================-->
        <asp:MultiView ID="PedidosPeriodoMultiView" runat="server" ActiveViewIndex="0" Visible="true">
                            ...
                            <asp:GridView ID="PedidosPeriodoGridView" EmptyDataText="Nenhum Período Localizado"
                                ...
                                <Columns>
                                    ...
                                    <asp:TemplateField HeaderText="Empresa" Visible="true">
                                        <ItemTemplate>
                                            <asp:Label ID="EmpCodLabel" runat="server" Text='<%# Bind("Empresa") %>'></asp:Label>
                                        </ItemTemplate>
                                    </asp:TemplateField>
                                    ...
                                    <asp:TemplateField HeaderText="Custo Produto">
                                        <ItemTemplate>
                                            <asp:Label ID="EmpNomeFantLabel" runat="server" Text='<%# Bind("Custo") %>'></asp:Label>
                                        </ItemTemplate>
                                    </asp:TemplateField>
