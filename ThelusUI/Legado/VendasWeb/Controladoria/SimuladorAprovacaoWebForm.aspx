<%@ Page Title="" Language="C#" MasterPageFile="~/CRM.Master" AutoEventWireup="true" CodeBehind="SimuladorAprovacaoWebForm.aspx.cs" Inherits="VendasWeb.Controladoria.SimuladorAprovacaoWebForm" %>
        ...
        <div class="col-sm-9">
            ...
            <div class="panel panel-info">
                ...
                <div class="panel-heading">
                    ...
                    <h3 class="panel-title">Controladoria - Simulador de preços</h3>
                </div>
                <!--Painel Aberto-->
                ...
                <div class="panel-body">
                    ...
                    <div class="row">
                        ...
                        <div class="col-sm-2">
                            <div class="form-group">
                                <asp:Label ID="LabelMargem" runat="server" Text="M. Contribuição:"></asp:Label>
                            </div>
                        </div>
                        <div class="col-sm-4">
                            <div class="form-group">
                                <asp:TextBox ID="MargemContribuicaoTextBox" runat="server" ReadOnly="true" Enabled="false" Style="width: 92%;"></asp:TextBox>
                            </div>
                        </div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-4">
                            <div class="form-group">
                                <asp:CheckBox ID="ClienteCheck" runat="server" AutoPostBack="true" />
                            </div>
                        </div>
                ...
                <div class="row">
                    ...
                    <div class="col-sm-10">
                        <div class="form-group">
                            <asp:TextBox ID="ClienteInput" runat="server" Style="width: 97%;" ReadOnly="true"></asp:TextBox>
                ...
                <div class="row">
                    <div class="col-sm-6">
                        <div class="form-group">
                            <asp:Label ID="ObservacaoLabel" runat="server" Text="Histórico :"></asp:Label>
                        </div>
                    </div>
                    <div class="col-sm-6">
                        <div class="form-group">
                    ...
                    <div class="col-sm-6" id="DivHist" runat="server">
                        <div class="form-group">
                            <asp:TextBox ID="ObservBox" Style="height: 100px; width: 97.5%;" TextMode="MultiLine" runat="server"></asp:TextBox>
                        </div>
                    </div>

                    <div class="col-sm-6">
                        <div class="form-group">
                            <asp:TextBox ID="NovoHistBox" Style="height: 100px; width: 97.5%;" TextMode="MultiLine" runat="server"></asp:TextBox>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="row">
                <div class="panel-control">
                    ...
                    <asp:LinkButton ID="AprovarButton" class="btn btn-success btn-labeled fa fa-check fa-lg"
                        CausesValidation="false" runat="server" OnClick="AprovarButton_Click">Aprovar</asp:LinkButton>
                    <asp:LinkButton ID="ReprovarButton" class="btn btn-success btn-labeled fa fa-times fa-lg"
                        CausesValidation="false" runat="server" OnClick="ReprovarButton_Click">Reprovar</asp:LinkButton>
                </div>
            </div>
        </div>
    </div>
