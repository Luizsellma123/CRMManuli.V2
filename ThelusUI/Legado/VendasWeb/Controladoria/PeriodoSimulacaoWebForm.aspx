<%@ Page Title="" Language="C#" MasterPageFile="~/NestedMasterPageCRM.master" AutoEventWireup="true" CodeBehind="PeriodoSimulacaoWebForm.aspx.cs" Inherits="VendasWeb.Controladoria.PeriodoSimulacaoWebForm" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
        ...
        <div class="col-sm-9">
            ...
            <div class="panel panel-info">
                ...
                <div class="panel-heading">
                    ...
                    <h3 class="panel-title">Períodos Inclusão Simulação</h3>
                </div>
                <!--Painel Aberto-->
        ...
        <!--===================================================-->
        <asp:MultiView ID="SimulacaoPeriodoMultiView" runat="server" ActiveViewIndex="0" Visible="false">
            <asp:View ID="SimulacaoPeriodoView" runat="server">
                <!-- TABELA -->
                <!--===================================================-->
                <div class="panel">
                    <div class="panel-heading">
                    ...
                    <div class="panel-body">
                        <div class="table-responsive">
                            <asp:GridView ID="SimulacaoPeriodoGridView" EmptyDataText="Nenhum Período Localizado"
                                ...
                                <Columns>
                                    ...
                                    <asp:TemplateField HeaderText="EmpCod" Visible="false">
                                        <ItemTemplate>
                                            <asp:Label ID="EmpCodLabel" runat="server" Text='<%# Bind("IDPerido") %>'></asp:Label>
                                        </ItemTemplate>
                                    </asp:TemplateField>
                                    <asp:TemplateField HeaderText="Código" Visible="false">
                                        <ItemTemplate>
                                            <asp:Label ID="CodigoLabel" runat="server" Text='<%# Bind("IDPerido") %>'></asp:Label>
                                        </ItemTemplate>
                                    </asp:TemplateField>
                                    <asp:TemplateField HeaderText="Descrição">
                                        <ItemTemplate>
                                            <asp:Label ID="EmpNomeFantLabel" runat="server" Text='<%# Bind("Descricao") %>'></asp:Label>
                                        </ItemTemplate>
                                    </asp:TemplateField>
                                    ...
                                    <asp:TemplateField HeaderText="Data Inicial">
                                        <ItemTemplate>
                                            ...
                                            <asp:TextBox AutoPostBack="true" ID="DataInicialTextBox" TextMode="Date" OnTextChanged="DataInicialTextBox_TextChanged" runat="server" Text='<%# Eval("DataInicio", "{0:yyyy-MM-dd}")%>'></asp:TextBox>
                                        </ItemTemplate>
                                    </asp:TemplateField>
                                    <asp:TemplateField HeaderText="Data Final">
                                        <ItemTemplate>
                                            <%--<asp:Label ID="DataFinalLabel" runat="server" Text='<%# Bind("DataFinal") %>'></asp:Label>--%>
                                            <asp:TextBox AutoPostBack="true" ID="DataFinalTextBox" TextMode="Date" OnTextChanged="DataFinalTextBox_TextChanged" runat="server" Text='<%# Eval("DataFim", "{0:yyyy-MM-dd}")%>'></asp:TextBox>
                                        </ItemTemplate>
                                    </asp:TemplateField>
                                </Columns>
                            </asp:GridView>
