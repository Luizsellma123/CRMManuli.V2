<%@ Page Title="" Language="C#" MasterPageFile="~/CRM.Master" AutoEventWireup="true" CodeBehind="ListaSimuladorControladoria.aspx.cs" Inherits="VendasWeb.Controladoria.ListaSimuladorControladoria" %>
        ...
        <div class="col-sm-9">
            ...
            <div class="panel panel-info">
                ...
                <div class="panel-heading">
                    ...
                    <h3 class="panel-title">Controladoria - Lista Simulador Preço</h3>
                </div>
                <!--Painel Aberto-->
                ...
                <div class="panel-body">
                    ...
                    <div class="col-sm-4">
                            <div class="form-group">
                                <div class="form-group">
                                <asp:DropDownList ID="SituacaoDropDown" runat="server" style="width:93%;" CssClass="selectpicker show-tick"></asp:DropDownList>
                            </div>
                            </div>
                        </div>
                        </div>
                   ...
                   <div class="col-sm-2">
                    ...
                    <div class="col-sm-4">
                            <div class="form-group">
                                <div class="form-group">
                                   <input runat="server" style="width: 93%;" id="VendedorText" type="text" class="form-control" placeholder="Nome do vendedor"/></div>                                                                     
                                </div>
                            </div>
                        </div>
                        </div>                                                                  
                        ...
                        <div class="table-responsive">
                            ...
                            <asp:GridView ID="SimulacoesGridView" EmptyDataText="Não foi possível encontrar nenhuma simulação" AutoGenerateColumns="False"
                                ...
                                <Columns>
                                    ...
                                    <asp:TemplateField HeaderText="Acessar "  ItemStyle-Width="5%">
                                        <ItemTemplate>
                                    ...
                                    <asp:TemplateField HeaderText="Simulação "  ItemStyle-Width="10%">
                                        <ItemTemplate>
                                            <asp:Label ID="IdSimGrid" runat="server" Text='<%# Bind("IDSimulacao") %>'></asp:Label>
                                        </ItemTemplate>
                                    </asp:TemplateField>

                                    <asp:TemplateField HeaderText="Vendedor "  ItemStyle-Width="25%">
                                        <ItemTemplate>
                                            <asp:Label ID="VendedorGrid" runat="server" Text='<%# Bind("Vendedor") %>'></asp:Label>
                                        </ItemTemplate>
                                    </asp:TemplateField>

                                    <asp:TemplateField HeaderText="Nome Cliente "  ItemStyle-Width="40%">
                                        <ItemTemplate>
                                            <asp:Label ID="ClienteGrid" runat="server" Text='<%# Bind("NomeCliente") %>'></asp:Label>
                                        </ItemTemplate>
                                    </asp:TemplateField>

                                    <asp:TemplateField HeaderText="Data Simulacao "  ItemStyle-Width="10%">
                                        <ItemTemplate>
                                            <asp:Label ID="DataGrid" runat="server" Text='<%# Bind("DataSimulacao") %>'></asp:Label>
                                        </ItemTemplate>
                                    </asp:TemplateField>

                                    <asp:TemplateField HeaderText="Situação "  ItemStyle-Width="10%">
                                        <ItemTemplate>
