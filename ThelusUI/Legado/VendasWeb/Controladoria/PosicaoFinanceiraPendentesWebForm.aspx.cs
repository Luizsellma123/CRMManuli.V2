...
{
    public partial class PosicaoFinanceiraPendentesWebForm : System.Web.UI.Page
    {
        ...
        protected void BuscarButton_Click(object sender, EventArgs e)
        {
            ...
            PosicaoFinanceiraGridView.DataSource = objControladoriaClass.Consulta_CRM_POSICAO_DIARIA_PENDENTES(0);
        ...
        protected void ExcelCompletoLinkButton_Click(object sender, EventArgs e)
        {
            ...
            DataTable Excel = objControladoriaClass.Consulta_CRM_POSICAO_DIARIA_PENDENTES(1);

            string tabelaHTML = objControladoriaClass.MontaTabelaHtmlDoExcel(Excel);

            SalvaTabelaHTMLComoExcel(tabelaHTML, "ConsolidadoGeralPendentes");
        }
