<%@ Page Title="" Language="C#" MasterPageFile="~/NestedMasterPageCRM.master" AutoEventWireup="true" CodeBehind="PosicaoFinanceiraPendentesWebForm.aspx.cs" Inherits="VendasWeb.Controladoria.PosicaoFinanceiraPendentesWebForm" %>
        ...
        <div class="col-sm-9">
            ...
            <div class="panel panel-info">
                ...
                <div class="panel-heading">
                    ...
                    <h3 class="panel-title">Controladoria - Posição Financeira - Pendentes</h3>
                </div>
                <!--Painel Aberto-->
                            ...
                            <div class="form-group">
                                <div class="form-group">
                                    <asp:DropDownList ID="StatusDropDownList" runat="server" CssClass="form-control">
                                        ...
                                        <asp:ListItem Text="Efetuado" Value="1" />
                                        <asp:ListItem Text="Disponível" Value="2" />
                                    </asp:DropDownList>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="table-responsive">
                            ...
                            <asp:GridView ID="PosicaoFinanceiraGridView" EmptyDataText="Não foi possível encontrar nenhuma Posição Financeira" AutoGenerateColumns="False"
                                ...
                                <Columns>
                                    ...
                                    <asp:BoundField DataField="Pedido" HeaderText="Pedido" ControlStyle-Width="5%" />

                                    <asp:BoundField DataField="Status" HeaderText="Status" ControlStyle-Width="5%" />

                                    <asp:BoundField DataField="DataPedido" HeaderText="Data Pedido" ControlStyle-Width="5%" />
