...
{
    public partial class PosicaoFinanceiraFaturadosWebForm : System.Web.UI.Page
    {
        ...
        protected void BuscarButton_Click(object sender, EventArgs e)
        {
            ...
            PosicaoFinanceiraGridView.DataSource = objControladoriaClass.Consulta_CRM_POSICAO_DIARIA_FATURADOS(0);
        ...
        protected void ExcelCompletoLinkButton_Click(object sender, EventArgs e)
        {
            ...
            DataTable Excel = objControladoriaClass.Consulta_CRM_POSICAO_DIARIA_FATURADOS(1);

            string tabelaHTML = objControladoriaClass.MontaTabelaHtmlDoExcel(Excel);

            SalvaTabelaHTMLComoExcel(tabelaHTML, "ConsolidadoGeralFaturados");
        }
