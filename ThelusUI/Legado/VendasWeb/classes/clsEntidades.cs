...
namespace VendasWeb.GerencialVendas
{
    ...
    public class clsEntidades : clsConexao
    {
        ...
        public void AdicionarCategoria(EntidadeCategoriaClass NewCategoria)
        {
            ...
            result = this.ListEntCategoriaClass.Where(L => L.CategCodEstr == NewCategoria.CategCodEstr).Count();
        ...
        public DataTable Consulta_Entidade()
        {
            ...
            try
            {
                ...
                using (SqlConnection dbConnection = new SqlConnection(strConec))
                {
                    ...
                    dbCommand = new SqlCommand("CRM_SP_RETORNA_CODIGOS_CLIENTES", dbConnection);

                    dbCommand.CommandType = CommandType.StoredProcedure;


                    dbCommand.Parameters.Add(new SqlParameter("@NomeCliente", SqlDbType.VarChar, 100, "NomeCliente"));
                    dbCommand.Parameters.Add(new SqlParameter("@NomeFantasia", SqlDbType.VarChar, 800, "NomeFantasia"));
                    dbCommand.Parameters.Add(new SqlParameter("@CodigoClienteSAP", SqlDbType.VarChar, 100, "CodigoClienteSAP"));
                    dbCommand.Parameters.Add(new SqlParameter("@CNPJ", SqlDbType.VarChar, 100, "CNPJ"));
                    dbCommand.Parameters.Add(new SqlParameter("@IDVendedores", SqlDbType.VarChar, 8000, "IDVendedores"));
                    ...
                    dbCommand.Parameters["@NomeCliente"].Value = EntNome ?? "";
                    dbCommand.Parameters["@NomeFantasia"].Value = EntNomeFant ?? "";
                    dbCommand.Parameters["@CodigoClienteSAP"].Value = EntCod ?? "";
                    dbCommand.Parameters["@IDVendedores"].Value = VendCod ?? "";
                    dbCommand.Parameters["@CNPJ"].Value = EntCpfCgc ?? "";
                    dbCommand.Parameters["@CodigoUsuario"].Value = UsuCod ?? "";
                    dbCommand.Parameters["@IDStatus"].Value = StatEntCod ?? "";
        ...
        public DataTable Consulta_Entidade_Acessos()
        {
            ...
            try
            {
                ...
                using (SqlConnection dbConnection = new SqlConnection(strConec))
                {
                    ...
                    dbCommand = new SqlCommand("CRM_SP_ACESSO_CLIENTE", dbConnection);
