...
namespace VendasWeb
{
    public class funcoesBD : GerencialVendas.clsConexao
    {
        ...
        public string gravaPedido(string empCod, string PedVendaNum, string TipoPedVenda, string DataEmissao,
            ...
            string descricaoStatus, double QuantidadeVolumes, string EspecieVolume, double PesoLiquido, double PesoBruto, string PedVendaNumPedEnt, string consumo)
        {
            string strError = "";
            using (SqlConnection dbConnection = new SqlConnection(strConec))
            {
                ...
                try
                {
                    ...
                    dbCommand.Parameters.Add(new SqlParameter("@vConsumo", SqlDbType.VarChar, 8000, "vConsumo"));
                    ...
                    if(tabela =="")
                        dbCommand.Parameters["@vTabPVCod"].Value = DBNull.Value;
                    else
                    ...
                    dbCommand.Parameters["@vConsumo"].Value = consumo;
        ...
        public string[] gravaBancoItemPedido(string empCod, string PedVendaNum, string vendedor, string entidade,
            ...
            string PedVendaNumPedEnt, int ItPedVendaNumSeq, string IPIInclusoICMS, string CodigoProdutoSAPCliche, string CodigoProdutoSAPArruela)
        {
            ...
            using (SqlConnection dbConnection = new SqlConnection(strConec))
            {
                ...
                if (strError == "")
                {
                    try
                    {
                        ...
                        if (codigoTabela == "")
                            dbCommandAux.Parameters["@vTabPVCod"].Value = DBNull.Value;
                        else
        ...
        public string aprovaPedido(string Empresa, string pedido, string usucod, string entcod)
        {
            ...
            using (SqlConnection dbConnection = new SqlConnection(strConec))
            {
                ...
                {
                    //Chama procedure para buscar número do pedido
                    SqlCommand dbCommand = new SqlCommand("CRM_SP_APROVACAO_PEDIDO_MARGEM", dbConnection);
        ...
        public string alteraSatusPedido(string Empresa, string pedido, string usucod, string entcod, string status, string descricao)
        {
            ...
            using (SqlConnection dbConnection = new SqlConnection(strConec))
            {
                ...
                {
                    //Chama procedure para buscar número do pedido
                    SqlCommand dbCommand = new SqlCommand("CRM_SP_Pedido_Atualiza_Status", dbConnection);
                    ...
                    dbCommand.Parameters["@IDEmpresa"].Value = Convert.ToInt32(Empresa);
                    dbCommand.Parameters["@IDPedido"].Value = Convert.ToInt32(pedido);
                    dbCommand.Parameters["@IDStatus"].Value = Convert.ToInt32(status);
        ...
        public string excluiItens(string Empresa, string pedido, string codigoProduto, int numSeq)
        {
            ...
            using (SqlConnection dbConnection = new SqlConnection(strConec))
            {
                ...
                {
                    //Chama procedure para buscar número do pedido
                    SqlCommand dbCommand = new SqlCommand("CRM_SP_EXCLUI_CRM_PEDIDO_ITENS", dbConnection);
                    ...
                    dbCommand.Parameters["@IDPedido"].Value = pedido;
                                             ...
                                             string IpiInclusoBase, string dataPedido, out double VALOR_TABPV, out double VALOR_PRODUTO, out string erro, out string TribBCod, out double AliqDiferimento, string tabelaPreco)
        {
            ...
            using (SqlConnection dbConnection = new SqlConnection(strConec))
            {
                ...
                try
                {
                    ...
                    dbCommand.Parameters.Add(new SqlParameter("@Request", SqlDbType.VarChar, 10, "Request"));
                    ...
                    dbCommand.Parameters.Add(new SqlParameter("@RESPONSE", SqlDbType.VarChar, 10, ParameterDirection.Output, false, 0, 0, "RESPONSE", DataRowVersion.Default, null));
                    ...
                    dbCommand.Parameters["@Request"].Value = "Nenhum";
                    ...
                    if (dbCommand.Parameters["@RESPONSE"].Value.ToString() != "")
                        InfItem.UTILIZA_MULTCOMPRA_OUT = ((string)dbCommand.Parameters["@RESPONSE"].Value);
