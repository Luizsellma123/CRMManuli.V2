<%@ Page Title="" Language="C#" MasterPageFile="~/NestedMasterPageCRM.master" AutoEventWireup="true" CodeBehind="CadastroTransportadorRegiaoMunicipiosWebForm.aspx.cs" Inherits="VendasWeb.Logistica_New.CadastroTransportadorRegiaoMunicipiosWebForm" %>
        ...
        <div class="col-sm-9">
            ...
            <div class="panel panel-info">
                ...
                <div class="panel-heading">
                    ...
                    <h3 class="panel-title">Cadastro Transportador - Região - Municípios</h3>
                </div>
                <!--Painel Aberto-->
                ...
                <div class="panel-body">
                    ...
                    <div class="row">
                        ...
                        <div class="col-sm-4">
                            <div class="form-group">
                                <asp:DropDownList ID="PaisDropDownList" runat="server" CssClass="form-control">
                            ...
                            <asp:GridView ID="GridView" EmptyDataText="Não foi possível encontrar nenhuma simulação" AutoGenerateColumns="False"
                                ...
                                <Columns>
                                    ...
                                    <asp:TemplateField HeaderText="IDPais" Visible="false">
                                        <ItemTemplate>
                                            <asp:Label ID="IDPaisGridViewLabel" runat="server" Text='<%# Bind("IDPais") %>'></asp:Label>
                                        </ItemTemplate>
                                    </asp:TemplateField>

                                    <asp:TemplateField HeaderText="País">
                                        <ItemTemplate>
                                            <asp:Label ID="PaisGridViewLabel" runat="server" Text='<%# Bind("Pais") %>'></asp:Label>
                                        </ItemTemplate>
                                    </asp:TemplateField>

                                    <asp:TemplateField HeaderText="IDEstado" Visible="false">
                                        <ItemTemplate>
                                            <asp:Label ID="IDEstadoGridViewLabel" runat="server" Text='<%# Bind("IDEstado") %>'></asp:Label>
                                        </ItemTemplate>
                                    </asp:TemplateField>

                                    <asp:TemplateField HeaderText="Estado">
                                        <ItemTemplate>
                                            <asp:Label ID="EstadoGridViewLabel" runat="server" Text='<%# Bind("Estado") %>'></asp:Label>
                                        </ItemTemplate>
                                    </asp:TemplateField>

                                    <asp:TemplateField HeaderText="IDMunicipio" Visible="false">
                                        <ItemTemplate>
                                            <asp:Label ID="IDMunicipioGridViewLabel" runat="server" Text='<%# Bind("IDMunicipio") %>'></asp:Label>
                                        </ItemTemplate>
                                    </asp:TemplateField>

                                    <asp:TemplateField HeaderText="Municipio">
                                        <ItemTemplate>
                                            <asp:Label ID="MunicipioGridViewLabel" runat="server" Text='<%# Bind("Municipio") %>'></asp:Label>
                                        </ItemTemplate>
                                    </asp:TemplateField>
