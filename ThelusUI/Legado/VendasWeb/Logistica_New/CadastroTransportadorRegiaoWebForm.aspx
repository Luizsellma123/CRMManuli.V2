<%@ Page Title="" Language="C#" MasterPageFile="~/NestedMasterPageCRM.master" AutoEventWireup="true" CodeBehind="CadastroTransportadorRegiaoWebForm.aspx.cs" Inherits="VendasWeb.Logistica_New.CadastroTransportadorRegiaoWebForm" %>
        ...
        <div class="col-sm-9">
            ...
            <div class="panel panel-info">
                ...
                <div class="panel-heading">
                    ...
                    <h3 class="panel-title">Cadastro Transportador - Região</h3>
                </div>
                <!--Painel Aberto-->
                ...
                <div class="panel-body">
                 ...
                 <asp:HiddenField ID="IDTransportadorHiddenField" runat="server" />
                    ...
                    <div class="row">
                        ...
                        <div class="col-sm-4">
                            <div class="form-group">
                                <asp:TextBox ID="CodigoRegiaoTextBox" runat="server" CssClass="form-control"></asp:TextBox>
                            </div>
                        </div>
                        ...
                        <div class="col-sm-4">
                            <div class="form-group">
                                <asp:TextBox ID="DescricaoRegiaoTextBox" runat="server" CssClass="form-control"></asp:TextBox>
                            </div>
                        </div>
                        ...
                        <div class="table-responsive">
                            ...
                            <asp:GridView ID="GridView" EmptyDataText="Não foi possível encontrar nenhuma simulação" AutoGenerateColumns="False"
                                ...
                                <Columns>
                                    ...
                                    <asp:TemplateField HeaderText="IDRegiao" Visible="false">
                                        <ItemTemplate>
                                            <asp:Label ID="IDRegiaoGridViewLabel" runat="server" Text='<%# Bind("IDRegiao") %>'></asp:Label>
                                        </ItemTemplate>
                                    </asp:TemplateField>

                                    <asp:TemplateField HeaderText="Região">
                                        <ItemTemplate>
                                            <asp:Label ID="RegiaoGridViewLabel" runat="server" Text='<%# Bind("Regiao") %>'></asp:Label>
                                        </ItemTemplate>
                                    </asp:TemplateField>

                                     <asp:TemplateField HeaderText="Municipios">
                                        <ItemTemplate>
                                            <center>
                                                <asp:LinkButton ID="MunicipiosGridViewLinkButton" class="btn btn-info fa fa-plus"
                                                    CausesValidation="false" runat="server" OnClick="MunicipiosGridViewLinkButton_Click">
                                                </asp:LinkButton>
                                            </center>
                                        </ItemTemplate>
                                        <HeaderStyle Width="10px" />
                                    ...
                                    <asp:TemplateField HeaderText="Parâmetros">
                                        <ItemTemplate>
                                            <center>
                                                <asp:LinkButton ID="ParametrosGridViewLinkButton" class="btn btn-info fa fa-plus"
                                                    CausesValidation="false" runat="server" OnClick="ParametrosGridViewLinkButton_Click">
                                                </asp:LinkButton>
                                            </center>
                                        </ItemTemplate>
                                        <HeaderStyle Width="10px" />
