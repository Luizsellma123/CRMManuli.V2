<%@ Page Title="" Language="C#" MasterPageFile="~/NestedMasterPageCRM.master" AutoEventWireup="true" CodeBehind="StatusFechamentoFaturaWebForm.aspx.cs" Inherits="VendasWeb.Logistica_New.StatusFechamentoFaturaWebForm" %>
        ...
        <div class="col-sm-9">
            ...
            <div class="panel panel-info">
                ...
                <div class="panel-heading">
                    ...
                    <h3 class="panel-title">Fechamento Fatura - Status Lista</h3>
                </div>
                <!--Painel Aberto-->
                            ...
                            <asp:GridView ID="GridView" EmptyDataText="Não foi possível encontrar nenhuma simulação" AutoGenerateColumns="False"
                                ...
                                <Columns>
                                    ...
                                    <asp:TemplateField HeaderText="Editar">
                                        <ItemTemplate>
                                            <center>
                                                <asp:LinkButton ID="EditarGridViewLinkButton" class="btn btn-info fa fa-edit"
                                                    CausesValidation="false" runat="server" OnClick="EditarGridViewLinkButton_Click"></asp:LinkButton>
                                            </center>
                                        </ItemTemplate>
                                    ...
                                    <asp:TemplateField HeaderText="Bloqueado Alteração">
                                        <ItemTemplate>
                                            <asp:Label ID="BloqueadoAlteracaoGridViewLabel" runat="server" Text='<%# Bind("BloqueadoAlteracao") %>'></asp:Label>
                                        </ItemTemplate>
                                    </asp:TemplateField>
