<%@ Page Title="" Language="C#" MasterPageFile="~/NestedMasterPageCRM.master" AutoEventWireup="true" CodeBehind="FechamentoFaturaWebForm.aspx.cs" Inherits="VendasWeb.Logistica_New.FechamentoFaturaWebForm" %>
        ...
        <div class="col-sm-9">
            ...
            <div class="panel panel-info">
                ...
                <div class="panel-heading">
                    ...
                    <h3 class="panel-title">Fechamento Fatura - Lista</h3>
                </div>
                <!--Painel Aberto-->
                ...
                <div class="panel-body">
                    ...
                    <div class="row">
                        ...
                        <div class="col-sm-2">
                            <div class="form-group">
                                <asp:Label runat="server" Text="Número Fatura:"></asp:Label>
                            </div>
                        </div>

                        <div class="col-sm-4">
                            <div class="form-group">
                                <asp:TextBox ID="NumeroFaturaTextBox" runat="server" CssClass="form-control"></asp:TextBox>
                            </div>
                        </div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-sm-2">
                            <div class="form-group">
                                <asp:Label runat="server" Text="Parceiro:"></asp:Label>
                            </div>
                        </div>

                        <div class="col-sm-4">
                            <div class="form-group">
                                <asp:TextBox ID="ParceiroTextBox" runat="server" CssClass="form-control"></asp:TextBox>
                            </div>
                        </div>
                        ...
                        <div class="table-responsive">
                            ...
                            <asp:GridView ID="GridView" EmptyDataText="Não foi possível encontrar nenhuma simulação" AutoGenerateColumns="False"
                                ...
                                <Columns>
                                    ...
                                    <asp:TemplateField HeaderText="Fechamento">
                                        <ItemTemplate>
                                            <asp:Label ID="FechamentoGridViewLabel" runat="server" Text='<%# Bind("Fechamento") %>'></asp:Label>
                                        </ItemTemplate>
                                        <HeaderStyle Width="10px" />
                                    </asp:TemplateField>
                                    ...
                                    <asp:TemplateField HeaderText="Fatura">
                                        <ItemTemplate>
                                            <asp:Label ID="FaturaGridViewLabel" runat="server" Text='<%# Bind("Fatura") %>'></asp:Label>
                                        </ItemTemplate>
                                        <HeaderStyle Width="10px" />
                                    </asp:TemplateField>
