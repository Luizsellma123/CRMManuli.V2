<%@ Page Title="" Language="C#" MasterPageFile="~/CRM.Master" AutoEventWireup="true" CodeBehind="FrmOrcamento.aspx.cs" Inherits="VendasWeb.AprovarOrcamento.FrmOrcamento" %>
    ...
    <div class="row">
        ...
        <div class="col-sm-12">
            ...
            <div class="panel panel-info">
                ...
                <div class="panel-heading">
                    ...
                    <h3 class="panel-title">Libera Pedido</h3>
                </div>
                <!--Painel Aberto-->
                ...
                <div class="panel-body">
                        ...
                        <div class="col-sm-3">
                            <div class="form-group">
                                ...
                                <asp:DropDownList ID="SituacaoDropDown" runat="server" CssClass="form-control">
                                    ...
                                    <asp:ListItem Value="Retornado">Retornado</asp:ListItem>
                                    <asp:ListItem Value="Cancelado">Não Aprovado</asp:ListItem>
                                </asp:DropDownList>
                    ...
                    <div class="row">
                        ...
                        <div class="col-sm-3">
                            <div class="form-group">
                                <h5>
                                    <asp:Label ID="LabelDataInicial" runat="server" Text="Inicial :"></asp:Label></h5>
                                <asp:TextBox ID="DataInicialTextBox" runat="server" type="date" CssClass="form-control"></asp:TextBox>
                            </div>
                        </div>
                        ...
                        <div class="col-sm-3">
                            <div class="form-group">
                                <h5>
                                    <asp:Label ID="LabelDataFinal" runat="server" Text="Final :"></asp:Label></h5>
                    ...
                    <div class="row">
                        ...
                        <div class="col-sm-10">
                            <div class="form-group">
                                ...
                                <asp:CheckBox ID="AlcadaSupervisorCheckBox" runat="server"></asp:CheckBox>
                                <asp:Label ID="Label2" runat="server" Text="Supervisor"></asp:Label>
                                &nbsp;&nbsp;
                                
                              
                                <%--<asp:CheckBox ID="AlcadaRegionalCheckBox" runat="server"></asp:CheckBox>--%>
                                <%--<asp:Label ID="Label3" runat="server" Text="Regional"></asp:Label>--%>

                                &nbsp;&nbsp;
                                <asp:CheckBox ID="AlcadaControladoriaCheckBox" runat="server"></asp:CheckBox>
                                <asp:Label ID="Label4" runat="server" Text="Controladoria"></asp:Label>

                                <%-- &nbsp;&nbsp; --%>
                                <%-- <asp:CheckBox ID="AlcadaDiretoriaCheckBox" runat="server"></asp:CheckBox> --%>
                                <%-- <asp:Label ID="Label5" runat="server" Text="Diretoria"></asp:Label> --%>

                                &nbsp;&nbsp;
                                <asp:CheckBox ID="AlcadaTodosCheckBox" runat="server"></asp:CheckBox>
                    ...
                    <div class="row" style="display: none;">
                        ...
                        <div class="col-sm-3" style="visibility: hidden;">
                            <div class="form-group" style="visibility: hidden;">
                                <h5>
                                    <asp:Label ID="LblConcluido" runat="server" Text="Concluido :" Style="visibility: hidden;"></asp:Label></h5>
                                <asp:DropDownList ID="ConcluidoDropDown" runat="server" CssClass="form-control" Style="visibility: hidden;">
                                    <asp:ListItem Value="">Todos</asp:ListItem>
                        ...
                        <div class="col-sm-3" style="visibility: hidden;">
                            <div class="form-group" style="visibility: hidden;">
                                <h5>
                                    <asp:Label ID="LblAprovados" runat="server" Text="Analisados :" Style="visibility: hidden;"></asp:Label></h5>
                                <asp:DropDownList ID="AprovadosDropDown" runat="server" CssClass="form-control" Style="visibility: hidden;">
                                    <asp:ListItem Value="">Todos</asp:ListItem>
                                    <asp:ListItem Value="Sim">Sim</asp:ListItem>
                    ...
                    <div class="row">
                        <div class="panel-control">
                            ...
                            <asp:LinkButton ID="BuscarLinkButton" class="btn btn-success btn-labeled fa fa-search fa-lg"
                                CausesValidation="false" OnClick="BuscarLinkButton_Click1" runat="server">Buscar</asp:LinkButton>
        ...
        <asp:MultiView ID="MultiView" runat="server" ActiveViewIndex="0" Visible="false">
            <asp:View ID="View" runat="server">
                ...
                <div class="panel">
                    <div class="panel-heading">
                        <h3 class="panel-title">Lista Orçamentos
                        </h3>
                    </div>
                    <!-- Foo Table - Filtering -->
                    <!--===================================================-->
                        ...
                        <div class="table-responsive">
                            ...
                            <asp:GridView ID="OrcamentoGridView" EmptyDataText="Nenhum Orçamento Localizado" AutoGenerateColumns="False"
                                ...
                                <Columns>
                                    ...
                                    <asp:TemplateField HeaderText="Outros Dados">
                                        <ItemTemplate>
                                            <asp:Label ID="OutrosDadosLabel" runat="server" Text='<%# Bind("OutrosDados") %>'></asp:Label>
                                        </ItemTemplate>
                                    </asp:TemplateField>


                                    <asp:TemplateField HeaderText="Concluido">
                                        <ItemTemplate>
                                            <asp:Label ID="ConcluidoLabel" runat="server" Text='<%# Bind("Concluido") %>'></asp:Label>
                                        </ItemTemplate>
                                    </asp:TemplateField>
                                    ...
                                    <asp:TemplateField HeaderText="Supervisor">
                                        <ItemTemplate>
                                            <center>
                                                <asp:Literal ID="AprovadoSupervisorLiteral" runat="server" Text='<%# Bind("AprovadoSupervisor") %>'></asp:Literal></center>
                                        </ItemTemplate>
                                    </asp:TemplateField>
                                    ...
                                    <%--<asp:TemplateField HeaderText="Regional">
                                        <ItemTemplate>
                                            <center>
                                            <asp:Literal ID="AprovadoRegionalLiteral" runat="server" Text='<%# Bind("AprovadoRegional") %>'></asp:Literal></center>
                                        </ItemTemplate>
                                    </asp:TemplateField>--%>

                                    <asp:TemplateField HeaderText="Controladoria">
                                        <ItemTemplate>
                                            <center>
                                                <asp:Literal ID="AprovadoControladoriaLiteral" runat="server" Text='<%# Bind("AprovadoControladoria") %>'></asp:Literal></center>
                                        </ItemTemplate>
                                    </asp:TemplateField>
                                    ...
                                    <asp:TemplateField HeaderText="Diretoria">
                                        <ItemTemplate>
                                            <center>
                                            <asp:Literal ID="AprovadoDiretoriaLiteral" runat="server" Text='<%# Bind("AprovadoDiretoria") %>'></asp:Literal></center>
                                        </ItemTemplate>
                                    </asp:TemplateField>
                                    --%>
                                </Columns>
