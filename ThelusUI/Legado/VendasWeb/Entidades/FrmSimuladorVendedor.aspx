<%@ Page Title="" Language="C#" MasterPageFile="~/CRM.Master" AutoEventWireup="true" CodeBehind="FrmSimuladorVendedor.aspx.cs" Inherits="VendasWeb.GerencialVendas.FrmSimuladorVendedor" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    <script language="javascript" src="<%=Page.ResolveClientUrl("~/Scripts/jquery1.4.1.js?aux=1")%>"
        type="text/javascript"></script>
    <script language="javascript" src="<%=Page.ResolveClientUrl("~/Scripts/jquery.maskedinput.js?aux=1")%>"
        type="text/javascript"></script>
    <script language="javascript" src="<%=Page.ResolveClientUrl("~/javaScripts/JsMask.js?aux=1")%>"
        type="text/javascript"></script>
    <script language="javascript" src="<%=Page.ResolveClientUrl("~/js/JsMascarasGerais.js?aux=1")%>"
        type="text/javascript"></script>
                ...
                <div class="panel-body">
                            ...
                            <div class="form-group">
                                <div class="form-group">
                                    <asp:DropDownList ID="EstadoDropDown" runat="server" Style="width: 93%;" CssClass="form-control "
                                        AutoPostBack="true" OnSelectedIndexChanged="EstadoDropDown_SelectedIndexChanged">
                                    </asp:DropDownList>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-sm-4">
                            <div class="form-group">
                                <div class="form-group">
                                    <asp:DropDownList ID="VendedorDropDown" AutoPostBack="true" runat="server" Style="width: 93%;" CssClass="form-control">
            ...
            <div class="panel-footer">
                <div class="row">
                    ...
                    <div class="panel-control">
                        ...
                        <asp:LinkButton ID="AprovarLinkButton" class="btn btn-success btn-labeled fa fa-floppy-o fa-lg"
                            CausesValidation="false" runat="server" OnClick="AprovarButton_Click">Salvar Simulação</asp:LinkButton>
                    </div>
