<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="TicketAtividadeWebUserControl.ascx.cs" Inherits="VendasWeb.usercontrol.TicketAtividadeWebUserControl" %>
            ...
            <div class="row">
                ...
                <div class="col-xs-12">
                    ...
                    <asp:LinkButton ID="HistoricoLinkButton" class="btn btn-lg btn-block btn-info btn-labeled fa fa-edit fa-3x"
                        runat="server" title="Historico" CausesValidation="False" Enabled="false"
                    ...
                    <asp:LinkButton ID="AnexoLinkButton" class="btn btn-lg btn-block btn-info btn-labeled fa fa-paperclip fa-3x"
                        runat="server" title="Anexo" CausesValidation="False" Enabled="false"
