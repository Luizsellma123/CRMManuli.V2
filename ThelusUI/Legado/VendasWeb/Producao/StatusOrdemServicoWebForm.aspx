<%@ Page Title="" Language="C#" MasterPageFile="~/NestedMasterPageCRM.master" AutoEventWireup="true" CodeBehind="StatusOrdemServicoWebForm.aspx.cs" Inherits="VendasWeb.Producao.StatusOrdemServicoWebForm" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div class="row">
        <div class="col-sm-9">
            ...
            <div class="panel panel-info">
                ...
                <div class="panel-heading">
                    ...
                    <h3 class="panel-title">Produção - Status Ordem Serviço</h3>
                </div>
                <!--Painel Aberto-->
                ...
                <div class="panel-body">
                    ...
                    <div class="row">
                        ...
                        <div class="col-sm-10">
                            <div class="form-group">
                                <div class="form-group">
                                    <asp:TextBox ID="StatusTextBox" runat="server" CssClass="form-control" placeholder="Nome ou Código."></asp:TextBox>
                                </div>
                            </div>
                        </div>
        ...
        <!-- TABELA -->
        <!--===================================================-->
        <asp:MultiView ID="StatusMultiView" runat="server" ActiveViewIndex="0" Visible="false">
                ...
                <div class="panel">
                    ...
                    <div class="panel-body">
                        <div class="table-responsive">
                            ...
                            <asp:GridView ID="StatusGridView" EmptyDataText="Não foi possível encontrar nenhuma simulação" AutoGenerateColumns="False"
                                ...
                                Style="border-collapse: collapse; max-width: 100%" OnPageIndexChanging="StatusGridView_PageIndexChanging" Visible="true">
                                ...
                                <Columns>
                                    ...
                                    <asp:TemplateField HeaderText="Bloqueado Alteração">
                                        <ItemTemplate>
                                            <asp:Label ID="BloqueadoAlteracaoLabel" runat="server" Text='<%# Bind("BloqueadoAlteracao") %>'></asp:Label>
                                        </ItemTemplate>
                                    </asp:TemplateField>
