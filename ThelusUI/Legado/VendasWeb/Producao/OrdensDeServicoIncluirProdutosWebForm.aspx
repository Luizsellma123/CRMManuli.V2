<%@ Page Title="" Language="C#" MasterPageFile="~/NestedMasterPageCRM.master" AutoEventWireup="true" CodeBehind="OrdensDeServicoIncluirProdutosWebForm.aspx.cs" Inherits="VendasWeb.Producao.OrdensDeServicoIncluirProdutosWebForm" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="Head" runat="server">
    ...
    <script language="javascript" src="<%=Page.ResolveClientUrl("~/js/OrdensServicoIncluirProdutosJavaScript.js")%>" type="text/javascript"></script>
        ...
        <div class="col-sm-9">
            ...
            <div class="panel panel-info">
                ...
                <div class="panel-heading">
                    ...
                    <h3 class="panel-title">Ordem Serviço - Incluir Produtos</h3>
                </div>
                <!--Painel Aberto-->
                ...
                <div class="panel-body">
                    ...
                    <asp:HiddenField ID="IDOrdemServico" runat="server" />
                    ...
                    <div class="panel-control">
                        ...
                        <asp:UpdatePanel ID="UpdatePanel4" runat="server" UpdateMode="Conditional">
                            <ContentTemplate>
                                ...
                                <asp:LinkButton ID="IncluirPedidosButton" class="btn btn-primary btn-labeled fa fa-plus-circle fa-lg"
                                    CausesValidation="false" runat="server" OnClientClick="showProgress();" OnClick="IncluirPedidosButton_Click">Incluir Pedidos</asp:LinkButton>

                            </ContentTemplate>
                            <Triggers>
                                <asp:PostBackTrigger ControlID="VoltarButton" />
                                <asp:PostBackTrigger ControlID="BuscarLinkButton" />
                                <asp:PostBackTrigger ControlID="IncluirPedidosButton" />
                            </Triggers>
                        </asp:UpdatePanel>
                                                        ...
                                                        <ContentTemplate>
                                                            <div class="col-xs-5 text-left checkbox">
                                                                <label>
                                                                    ...
                                                                    <asp:CheckBox ID="SelCheckBox" runat="server"
                                                                        Checked='<%# Convert.ToBoolean(Eval("Selecionado")) %>'
                                                                        OnCheckedChanged="SelCheckBox_CheckedChanged" AutoPostBack="true" />
                                                                </label>
                                                            </div>
                                                        </ContentTemplate>
                                                        <Triggers>
                                                            <asp:AsyncPostBackTrigger ControlID="SelCheckBox" />
                                                        </Triggers>
                                                    </asp:UpdatePanel>
                                                </ItemTemplate>
                                            </asp:TemplateField>
                                            ...
                                            <asp:TemplateField HeaderText="Planejada">
                                                <ItemTemplate>
                                                    <asp:TextBox class="form-control" ID="PlanejadaTextBox"
                                                        ...
                                                        Text='<%# String.Format("{0:#.00}", Convert.ToDouble(Eval("Planejada"))) %>'
                                                        OnTextChanged="PlanejadaTextBox_TextChanged" runat="server" AutoPostBack="true"></asp:TextBox>
                                                </ItemTemplate>
                                            </asp:TemplateField>
                                                            ...
                                                            <div class="col-xs-5 text-left checkbox">
                                                                <label>
                                                                    ...
                                                                    <asp:CheckBox ID="EstqCheckBox" runat="server"
                                                                        Checked='<%# Convert.ToBoolean(Eval("Estoque")) %>'
                                                    ...
                                                    <asp:UpdatePanel ID="TesteUpdatePanel" runat="server" UpdateMode="Conditional">
                                                        <ContentTemplate>
                                                            <asp:LinkButton ID="DetalhesLinkButton" class="btn btn-primary fa fa-plus-square" CausesValidation="false" runat="server"
                                                                OnClientClick='<%# string.Format("ConsultaOrdensServicoDetalhe("+Eval("NumeroPedidoSAP")+","+Eval("IDITemSAP")+")")%>'></asp:LinkButton>
                                                        </ContentTemplate>
                                                        <Triggers>
        ...
        <div class="modal-dialog modal-xl">
            <div class="modal-content">
                <div class="modal-header" style="margin-top: 15px;">
                    <h4 id="modalTitle" class="modal-title">Ordem Serviço - Incluir Produtos</h4>
