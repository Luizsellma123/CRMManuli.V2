<%@ Page Title="" Language="C#" MasterPageFile="~/NestedMasterPageCRM.master" AutoEventWireup="true" CodeBehind="OrdensDeServicoOrdensProducaoWebForm.aspx.cs" Inherits="VendasWeb.Producao.OrdensDeServicoOrdensProducaoWebForm" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="Head" runat="server">
    ...
    <script language="javascript" src="<%=Page.ResolveClientUrl("~/js/OrdensServicoOrdensProducaoJavaScript.js")%>" type="text/javascript"></script>
        ...
        <div class="col-sm-9">
            ...
            <div class="panel panel-info">
                ...
                <div class="panel-heading">
                    ...
                    <h3 class="panel-title">Ordem Serviço - Ordens Produção</h3>
                </div>
                <!--Painel Aberto-->
                ...
                <div class="panel-body">
                    ...
                    <div class="row">
                        ...
                        <div class="col-sm-4">
                            <div class="form-group">
                                <div class="form-group">
                                    <asp:TextBox class="form-control" ID="OrdemTextBox" runat="server"></asp:TextBox>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-sm-2">
                            <div class="form-group">
                                <asp:Label ID="StatusOPLabel" runat="server" Text="Status OP:"></asp:Label>
                            </div>
                        </div>
                        ...
                        <div class="col-sm-4">
                            <div class="form-group">
                                <div class="form-group">
                                    <asp:DropDownList ID="StatusOPDropDownList" runat="server" CssClass="form-control">
                                        <asp:ListItem Value="">Todos</asp:ListItem>
                                        <asp:ListItem Value="C">Cancelada</asp:ListItem>
                                        <asp:ListItem Value="L">Fechada</asp:ListItem>
                                        <asp:ListItem Value="P">Planejada</asp:ListItem>
                                        <asp:ListItem Value="R">Liberada</asp:ListItem>
                            ...
                            <asp:GridView ID="OrdensServicoGridView" EmptyDataText="Não foi possível encontrar nenhuma simulação" AutoGenerateColumns="False"
                                ...
                                <Columns>
                                    ...
                                    <asp:TemplateField HeaderText="Ordem">
                                        <ItemTemplate>
                                            <asp:Label ID="OrdemLabel" runat="server" Text='<%# Bind("NumeroOrdemProducao") %>'></asp:Label>
                                        </ItemTemplate>
                                    </asp:TemplateField>
                                    ...
                                    <asp:TemplateField HeaderText="Quantidade">
                                        <ItemTemplate>
                                            <asp:Label ID="QuantidadeLabel" runat="server"
                                                Text='<%# String.Format("{0:#.00}", Convert.ToDouble(Eval("QuantidadePedido"))) %>'></asp:Label>
                                        </ItemTemplate>
                                    </asp:TemplateField>

                                    <asp:TemplateField HeaderText="Planejada">
                                        <ItemTemplate>
                                            <asp:Label ID="PlanejadaLabel" runat="server"
                                                Text='<%# String.Format("{0:#.00}", Convert.ToDouble(Eval("QuantidadePlanejada"))) %>'></asp:Label>
                                        </ItemTemplate>
                                    </asp:TemplateField>
                                            ...
                                            <asp:UpdatePanel ID="TesteUpdatePanel" runat="server" UpdateMode="Conditional">
                                                <ContentTemplate>
                                                    <asp:LinkButton ID="DetalhesLinkButton" class="btn btn-primary fa fa-plus-square" CausesValidation="false" runat="server"
                                                        OnClientClick='<%# string.Format("ConsultaOrdensServicoOrdensProducao("+Eval("IDEmpresa")+","+Eval("IDOrdemServico")+","
                                                        +Eval("NumeroPedidoSAP")+","+Eval("IDITemSAP")+","+Eval("NumeroOrdemProducao")+")")%>'></asp:LinkButton>
                                                </ContentTemplate>
                                                <Triggers>
        ...
        <div class="modal-dialog modal-xl">
            <div class="modal-content">
                <div class="modal-header" style="margin-top: 15px;">
                    <h4 id="modalTitle" class="modal-title">Ordem Serviço - Ordem Produção</h4>
                        ...
                        <div class="col-md-12 pad-top bg-gray" style="padding-right: 15px;">
                            <div class="row pad-lft pad-rgt">
                                ...
                                <table class="table table-condensed table-responsive">
                                    <thead>
                                        <tr class="bg-gray-light">
                                            <th style="width: 50%;">Numero OP</th>
                                            <th style="width: 50%;">Status OP</th>
                                        </tr>
                                    </thead>
                                    <tbody>
                                        <tr class="bg-gray-light">
                                            <td>
                                                <asp:Label runat="server" ID="NumeroOPModalLabel"></asp:Label></td>
                                            <td>
                                                <asp:Label runat="server" ID="StatusOPModalLabel"></asp:Label></td>
                                        </tr>
                                    </tbody>
                                </table>
                                ...
                                <table class="table table-condensed table-responsive">
                                    ...
                                    <tbody>
                                        <tr class="bg-gray-light">
                                            <td>
                                                <asp:Label runat="server" ID="DepositoModalLabel"></asp:Label></td>
                                            <td>
                                ...
                                <table class="table table-condensed table-responsive">
                                    <thead>
                                        <tr class="bg-gray-light">
                                            <th style="width: 50%;">Depósito Relacional</th>
                                    ...
                                    <tbody>
                                        <tr class="bg-gray-light">
                                            <td>
                                                <asp:Label runat="server" ID="DepositoRelacionalModalLabel"></asp:Label></td>
                                            <td>
                                ...
                                <asp:Label runat="server" ID="ItensFormatadoModalLabel"></asp:Label>
