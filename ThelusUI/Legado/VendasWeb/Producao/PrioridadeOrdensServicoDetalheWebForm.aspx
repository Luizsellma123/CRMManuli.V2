<%@ Page Title="" Language="C#" MasterPageFile="~/NestedMasterPageCRM.master" AutoEventWireup="true" CodeBehind="PrioridadeOrdensServicoDetalheWebForm.aspx.cs" Inherits="VendasWeb.Producao.PrioridadeOrdensServicoDetalheWebForm" %>
        ...
        <div class="col-sm-9">
            ...
            <div class="panel panel-info">
                ...
                <div class="panel-heading">
                    ...
                    <h3 class="panel-title">Produção - Prioridade Ordens de Serviço Detalhe </h3>
                </div>
                <!--Painel Aberto-->
                ...
                <div class="panel-body">
                    ...
                    <asp:HiddenField ID="IDSPrioridadeHiddenField" runat="server" />
                    ...
                    <div class="row">
                        ...
                        <div class="col-sm-4">
                            <div class="form-group">
                                <asp:TextBox class="form-control" ID="ValorTextBox" runat="server"
                                    onkeypress="mascara( this, mnum );" onblur="mascara( this, mnum );" onfocus="mascara( this, mnum );"></asp:TextBox>
                            </div>
                        </div>
