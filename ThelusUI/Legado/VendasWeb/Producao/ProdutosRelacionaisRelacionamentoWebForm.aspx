<%@ Page Title="" Language="C#" MasterPageFile="~/NestedMasterPageCRM.master" AutoEventWireup="true" CodeBehind="ProdutosRelacionaisRelacionamentoWebForm.aspx.cs" Inherits="VendasWeb.Producao.ProdutosRelacionaisRelacionamentoWebForm" %>
        ...
        <div class="col-sm-9">
            ...
            <div class="panel panel-info">
                ...
                <div class="panel-heading">
                    ...
                    <h3 class="panel-title">Produção - Produtos Relacionais - Relacionamento</h3>
                </div>
                <!--Painel Aberto-->
                ...
                <div class="panel-body">
                    ...
                    <div class="row">
                        <div class="col-sm-3">
                            <div class="form-group">
                                <asp:Label ID="ProdutoOrigemLabel" runat="server" Text="Produto Origem :"></asp:Label>
                            </div>
                        </div>
                        ...
                        <div class="col-sm-9">
                            <div class="form-group">
                                <div class="form-group">
                                    <asp:TextBox ID="ProdutoOrigemTextBox" runat="server" CssClass="form-control" ReadOnly></asp:TextBox>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-sm-3">
                            <div class="form-group">
                                <asp:Label ID="ProdutoRelacionalLabel" runat="server" Text="Produto Relacional :"></asp:Label>
                            </div>
                        </div>
                        ...
                        <div class="col-sm-9">
                            <div class="form-group">
                                <div class="form-group">
                                    <asp:TextBox ID="ProdutoRelacionalTextBox" runat="server" CssClass="form-control" placeholder="Nome ou Código."></asp:TextBox>
                                </div>
                            </div>
                        </div>
                ...
                <div class="panel">
                    ...
                    <div class="panel-body">
                        <div class="table-responsive">
                            ...
                            <asp:UpdatePanel ID="ProdutosRelacionaisUpdatePanel" runat="server" UpdateMode="Conditional">
                                <ContentTemplate>
                                    ...
                                    <asp:GridView ID="ProdutosRelacionaisGridView" EmptyDataText="Não foi possível encontrar nenhuma simulação" AutoGenerateColumns="False"
                                        ...
                                        <Columns>
                                                        ...
                                                        <ContentTemplate>
                                                            <div class="col-xs-1 text-left checkbox">
                                                                <label class="form-checkbox form-icon form-text">
                                                                    <asp:CheckBox ID="SelCheckBox" runat="server" onClick="showProgress();"
                                                                        Checked='<%# Convert.ToBoolean(Eval("Relacionado")) %>'
                                                                        OnCheckedChanged="SelCheckBox_CheckedChanged" AutoPostBack="true" />
                                                                </label>
                                                            </div>
                                                        </ContentTemplate>
                                                        <Triggers>
                                                            <asp:PostBackTrigger ControlID="SelCheckBox" />
                                                        </Triggers>
                                                    </asp:UpdatePanel>
                                                </ItemTemplate>
                                            </asp:TemplateField>
                                            ...
                                            <asp:TemplateField HeaderText="ID Produto Relacionado" Visible="false">
                                                <ItemTemplate>
                                                    <asp:Label ID="IDProdutoRelacionadoLabel" runat="server" Text='<%# Bind("IDProdutoOrigem") %>'></asp:Label>
                                                </ItemTemplate>
                                            </asp:TemplateField>

                                            <asp:TemplateField HeaderText="Produto Relacionado">
                                                <ItemTemplate>
                                                    <asp:Label ID="ProdutoRelacionadoLabel" runat="server" Text='<%# Bind("ProdutoOrigem") %>'></asp:Label>
                                                </ItemTemplate>
                                            </asp:TemplateField>
                                ...
                                <Triggers>
                                    <asp:AsyncPostBackTrigger ControlID="ProdutosRelacionaisGridView" />
                                </Triggers>
                            </asp:UpdatePanel>
