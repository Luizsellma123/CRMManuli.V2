<%@ Page Title="" Language="C#" MasterPageFile="~/NestedMasterPageCRM.master" AutoEventWireup="true" CodeBehind="OrdensDeServicoPrincipalWebForm.aspx.cs" Inherits="VendasWeb.Producao.OrdensDeServicoPrincipalWebForm" %>
        ...
        <div class="col-sm-9">
            ...
            <div class="panel panel-info">
                ...
                <div class="panel-heading">
                    ...
                    <h3 class="panel-title">Ordem Serviço - Principal</h3>
                </div>
                <!--Painel Aberto-->
                ...
                <div class="panel-body">
                    ...
                    <div class="row">
                        ...
                        <div class="col-sm-2">
                            <div class="form-group">
                                <asp:Label ID="EmissorLabel" runat="server" Text="Emissor :"></asp:Label>
                            </div>
                        </div>
                        ...
                        <div class="col-sm-4">
                            <div class="form-group">
                                <div class="form-group">
                                    <asp:TextBox class="form-control" ID="EmissorTextBox" runat="server"></asp:TextBox>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-sm-2">
                            <div class="form-group">
                                <asp:Label ID="DataEmissaoLabel" runat="server" Text="Data Emissão:"></asp:Label>
                            </div>
                        </div>

                        <div class="col-sm-4">
                            <div class="form-group">
                                <asp:TextBox class="form-control" ID="DataEmissaoTextBox" TextMode="Date" runat="server"></asp:TextBox>
                            </div>
                        </div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-sm-2">
                            <div class="form-group">
                                <asp:Label ID="OrdensProdLabel" runat="server" Text="Ordens Prod.: "></asp:Label>
                            </div>
                        </div>
                        ...
                        <div class="col-sm-4">
                            <div class="form-group">
                                <div class="form-group">
                                    <asp:TextBox class="form-control" ID="OrdensProdTextBox" runat="server"></asp:TextBox>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="panel-control">
                        ...
                        <asp:UpdatePanel ID="UpdatePanel4" runat="server" UpdateMode="Conditional">
                            <ContentTemplate>
                                ...
                                <asp:LinkButton ID="GravarLinkButton" class="btn btn-success btn-labeled fa fa-floppy-o fa-lg"
                                    CausesValidation="false" runat="server" OnClientClick="showProgress();" OnClick="GravarLinkButton_Click">Gravar</asp:LinkButton>

                                <asp:LinkButton ID="EnviarSAPButton" class="btn btn-primary btn-labeled fa fa-sort-amount-asc fa-lg"
                                    CausesValidation="false" runat="server" OnClientClick="showProgress();" OnClick="EnviarSAPButton_Click">Enviar SAP</asp:LinkButton>

                                <asp:LinkButton ID="CancelarOSLinkButton" class="btn btn-danger btn-labeled fa fa-ban fa-lg" Enabled="false"
                                    CausesValidation="false" runat="server" OnClientClick="showProgress();" OnClick="CancelarOSLinkButton_Click">Cancelar OS</asp:LinkButton>

                            </ContentTemplate>
                            <Triggers>
                                <asp:PostBackTrigger ControlID="VoltarButton" />
                                <asp:PostBackTrigger ControlID="GravarLinkButton" />
                                <asp:PostBackTrigger ControlID="EnviarSAPButton" />
                                <asp:PostBackTrigger ControlID="CancelarOSLinkButton" />
                            </Triggers>
                        </asp:UpdatePanel>
                        ...
                        <div class="table-responsive">
                            ...
                            <asp:UpdatePanel ID="TesteUpdatePanel3" runat="server" UpdateMode="Conditional">
                                <ContentTemplate>
                                    ...
                                    <asp:GridView ID="OrdensServicoGridView" EmptyDataText="Não foi possível encontrar nenhuma Ordem de Produção" AutoGenerateColumns="False"
                                        ...
                                        <Columns>
                                            ...
                                            <asp:TemplateField HeaderText="Ex.">
                                                <ItemTemplate>
                                                    <asp:UpdatePanel ID="ExUpdatePanel" runat="server" UpdateMode="Conditional">
                                                        <ContentTemplate>
                                            ...
                                            <asp:TemplateField HeaderText="Quantidade">
                                                <ItemTemplate>
                                                    <asp:Label ID="QuantidadeLabel" runat="server" Text='<%# String.Format("{0:#.00}", Convert.ToDouble(Eval("Quantidade"))) %>'></asp:Label>
                                                </ItemTemplate>
                                            </asp:TemplateField>
                                            ...
                                            <asp:TemplateField HeaderText="Planejada">
                                                <ItemTemplate>
                                                    <asp:TextBox class="form-control" ID="PlanejadaTextBox"
                                                        ...
                                                        Text='<%# String.Format("{0:#.00}", Convert.ToDouble(Eval("Planejada"))) %>' OnTextChanged="PlanejadaTextBox_TextChanged" runat="server"
                                                        AutoPostBack="true"></asp:TextBox>
                                                </ItemTemplate>
                                            </asp:TemplateField>

                                            <asp:TemplateField HeaderText="Planejada" Visible="false">
                                                <ItemTemplate>
                                                    <asp:TextBox class="form-control" ID="PlanejadaTextBox2"
                                                        onkeypress="mascara( this, mnumEvirgula );" onblur="mascara( this, mnumEvirgula );" onfocus="mascara( this, mnumEvirgula );"
                                                        Text='<%# String.Format("{0:#.00}", Convert.ToDouble(Eval("Planejada"))) %>' runat="server" ReadOnly="true"></asp:TextBox>
                                                </ItemTemplate>
                                            </asp:TemplateField>

                                            <asp:TemplateField HeaderText="Estq." ItemStyle-Width="5%">
                                                <ItemTemplate>
                                                    <asp:UpdatePanel ID="EstqUpdatePanel2" runat="server" UpdateMode="Conditional">
                                                        <ContentTemplate>
                                                            <div class="col-xs-5 text-left checkbox">
                                                                <label>
                                                                    <%--class="form-checkbox form-icon form-text"--%>
                                                                    <asp:CheckBox ID="EstqCheckBox" runat="server"
                                                                        Checked='<%# Convert.ToBoolean(Eval("Estq")) %>'
                                                                        OnCheckedChanged="EstqCheckBox_CheckedChanged" AutoPostBack="true" />
                                                                </label>
                                                            </div>
                                                        </ContentTemplate>
                                                        <Triggers>
                                                            <asp:PostBackTrigger ControlID="EstqCheckBox" />
                                                        </Triggers>
                                                    </asp:UpdatePanel>
                                                </ItemTemplate>
                                            </asp:TemplateField>

                                            <asp:TemplateField HeaderText="Estq." Visible="false" ItemStyle-Width="5%">
                                                <ItemTemplate>
                                                    <div class="col-xs-5 text-left checkbox">
                                                        <label>
                                                            <%--class="form-checkbox form-icon form-text"--%>
                                                            <asp:CheckBox ID="EstqCheckBox2" runat="server"
                                                                Checked='<%# Convert.ToBoolean(Eval("Estq")) %>' Enabled="false" />
                                                        </label>
                                                    </div>
                                                </ItemTemplate>
                                            </asp:TemplateField>
                                            ...
                                            <asp:TemplateField HeaderText="Entrega">
                                                <ItemTemplate>
                                                    <asp:Label ID="EntregaLabel" runat="server" Text='<%# Bind("Entrega") %>'></asp:Label>
                                                </ItemTemplate>
                                            </asp:TemplateField>
        ...
        <div class="modal-dialog modal-xl">
            <div class="modal-content">
                <div class="modal-header" style="margin-top: 15px;">
                    <h4 id="modalTitle" class="modal-title">Ordem Serviço - Principal</h4>
