...
{
    public partial class HistoricoWebForm : System.Web.UI.Page
    {
        ...
        protected void CarregaCombos()
        {
            ...
            EventoDropDownList.DataSource = objRecebimento.ConsultaHistoricoEventos();
        ...
        {
            int IDEvento = Convert.ToInt32(EventoDropDownList.SelectedValue);

            CategoriaDropDownList.DataSource = objRecebimento.ConsultaHistoricoEventosCategorias(IDEvento);
        ...
        protected string CarregaDadosDaTela()
        {
            try
            {
                ...
                objRecebimento.IDEvento = Convert.ToInt32(EventoDropDownList.SelectedValue);

                if (objRecebimento.IDEvento == 0) return "Selecione o evento.";

                objRecebimento.IDCategoria = Convert.ToInt32(CategoriaDropDownList.SelectedValue);

                if (objRecebimento.IDCategoria == 0) return "Selecione a categoria.";

                objRecebimento.IDUsuarioLogado = Convert.ToInt32(Session["IDUsuario"]);

                objRecebimento.Historico = HistoricoTextBox.Text;

                if (string.IsNullOrEmpty(objRecebimento.Historico)) return "Informe o histórico.";
        ...
        public void CarregaHistoricoLiteral()
        {
            ...
            objRecebimento.ConsultaRecebimentoHistorico();

            HitoricoLiteral.Text = objRecebimento.Historico;
        }
        ...
        protected void GravarLinkButton_Click(object sender, EventArgs e)
        {
            ...
            if (erro == "")
            {
                erro = objRecebimento.GravaRecebimentoHistorico();
