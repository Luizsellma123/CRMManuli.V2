<%@ Page Language="C#" EnableEventValidation="false" AutoEventWireup="true" CodeBehind="Login.aspx.cs" Inherits="VendasWeb.Login" %>
...
<head runat="server">
    ...
    <title>CRM | Manupackaging</title>
	<link rel="shortcut icon" href="<%=Page.ResolveClientUrl("~/")%>img/logomanuli2.png">
    <!--STYLESHEET-->
    <!--=================================================-->
