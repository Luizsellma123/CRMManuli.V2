...
{
    public class HPCRELFORPER : SuperClasseDadosSerasa
    {
       ...
       //[JsonProperty("DES-REL")]
        public string DESREL { get; set; }

       //[JsonProperty("QTD-REL")]
        public string QTDREL { get; set; }
        ...
        public override string GravaDados(int IDCliente, int IDAnalise)
        {
            try
            {
                ...
                using (SqlConnection dbConnection = new SqlConnection(strConec))
                {
                    ...
                    dbCommand.Parameters["@DESREL"].Value = DESREL ?? "";
                    dbCommand.Parameters["@QTDREL"].Value = QTDREL ?? "";
