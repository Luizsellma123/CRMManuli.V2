...
{
    public class FILIAIS : SuperClasseDadosSerasa
    {
        ...
        //[JsonProperty("NM-FIL")]
        public string NMFIL { get; set; }

        public string CDEB { get; set; }
        ...
        public override string GravaDados(int IDCliente, int IDAnalise)
        {
            try
            {
                ...
                using (SqlConnection dbConnection = new SqlConnection(strConec))
                {
                    ...
                    SqlCommand dbCommand = new SqlCommand("CRM_SP_GRAVA_ANALISE_SERASA_FILIAIS", dbConnection);
                    ...
                    dbCommand.Parameters.Add(new SqlParameter("@NMFIL", SqlDbType.VarChar, 8000, "NMFIL"));
                    dbCommand.Parameters.Add(new SqlParameter("@CDEB", SqlDbType.VarChar, 8000, "CDEB"));
                    ...
                    dbCommand.Parameters["@NMFIL"].Value = NMFIL ?? "";
                    dbCommand.Parameters["@CDEB"].Value = CDEB ?? "";
