...
{
    public class RISKSCORINGPRINAD2 : SuperClasseDadosSerasa
    {
        ...
        public override string GravaDados(int IDCliente, int IDAnalise)
        {
            ...
            try
            {
                ...
                using (SqlConnection dbConnection = new SqlConnection(strConec))
                {
                    ...
                    SqlCommand dbCommand = new SqlCommand("CRM_SP_GRAVA_ANALISE_SERASA_RISKSCORING_PRINAD_INF", dbConnection);
                    ...
                    dbCommand.Parameters.Add(new SqlParameter("@AUTORIZADOR", SqlDbType.VarChar, 8000, "AUTORIZADOR"));
                    ...
                    dbCommand.Parameters["@AUTORIZADOR"].Value = AUTORIZADOR ?? "";
