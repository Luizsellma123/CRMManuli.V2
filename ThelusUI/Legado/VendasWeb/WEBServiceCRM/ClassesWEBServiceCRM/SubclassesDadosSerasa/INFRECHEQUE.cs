...
{
    public class INFRECHEQUE : SuperClasseDadosSerasa
    {
        ...
        public string QTDOCO { get; set; }
        public string QTDULTOCO { get; set; }
        ...
        public override string GravaDados(int IDCliente, int IDAnalise)
        {
            try
            {
                ...
                using (SqlConnection dbConnection = new SqlConnection(strConec))
                {
                    ...
                    SqlCommand dbCommand = new SqlCommand("CRM_SP_GRAVA_ANALISE_SERASA_RECHEQUE", dbConnection);
                    ...
                    dbCommand.Parameters.Add(new SqlParameter("@QTDOCO", SqlDbType.VarChar, 8000, "QTDOCO"));
                    dbCommand.Parameters.Add(new SqlParameter("@QTDULTOCO", SqlDbType.VarChar, 8000, "QTDULTOCO"));
                    ...
                    dbCommand.Parameters["@QTDOCO"].Value = QTDOCO ?? "";
                    dbCommand.Parameters["@QTDULTOCO"].Value = QTDULTOCO ?? "";
