...
{
    public class MENSAGEM : SuperClasseDadosSerasa
    {
        ...
        public override string GravaDados(int IDCliente, int IDAnalise)
        {
            try
            {
                ...
                using (SqlConnection dbConnection = new SqlConnection(strConec))
                {
                    ...
                    SqlCommand dbCommand = new SqlCommand("CRM_SP_GRAVA_ANALISE_SERASA_MENSAGEM", dbConnection);
                    ...
                    dbCommand.Parameters.Add(new SqlParameter("@MENS", SqlDbType.VarChar, 8000, "MENS"));
                    ...
                    dbCommand.Parameters["@MENS"].Value = MENS ?? "";
