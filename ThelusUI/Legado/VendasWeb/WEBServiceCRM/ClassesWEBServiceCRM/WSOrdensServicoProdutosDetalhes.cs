...
{
    public class WSOrdensServicoProdutosDetalhes : GerencialVendas.clsConexao
    {
        ...
        public void RecuperaOrdensServico()
        {
            ...
            try
            {
                using (SqlConnection dbConnection = new SqlConnection(strConec))
                {
                    ...
                    SqlCommand dbCommand = new SqlCommand("CRM_SP_RETORNA_WS_ORDENS_SERVICO", dbConnection);
