...
namespace VendasWeb.cadastros
{
    public partial class imagemCliches2 : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            strSQL = "select FP.ProdFoto, P.ProdNome from FOTO_PROD FP, Produto P  where (P.ProdCodEstr ='" + codigoProduto + "' or P.ProdCodAlt ='" + codigoProduto + "' ) and FP.ProdCodEstr=P.ProdCodEstr ";
