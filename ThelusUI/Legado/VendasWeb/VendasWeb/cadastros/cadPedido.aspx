<%@ Page Title="" Language="C#" MasterPageFile="~/VendasWeb.Master" AutoEventWireup="true" CodeBehind="cadPedido.aspx.cs" Inherits="VendasWeb.cadPedido" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
        ...
        <div id="ped_cabecario">
            ...
            <!--Filtro Nome/Codigo -->
            <asp:Label ID="lblEntidade" runat="server" Text="Entidade:"  CssClass="texto"></asp:Label>
            ...
            <asp:TextBox ID="txtFiltroEntCod" runat="server" CssClass="campo"></asp:TextBox>
